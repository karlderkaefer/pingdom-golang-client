...
// checks if the SingleRespResult type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SingleRespResult{}
...
// GetProbedescOk returns a tuple with the Probedesc field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SingleRespResult) GetProbedescOk() (*string, bool) {
	if o == nil || IsNil(o.Probedesc) {
		return nil, false
	}
	return o.Probedesc, true
}
...
func (o SingleRespResult) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.Probedesc) {
		toSerialize["probedesc"] = o.Probedesc
	}
	return toSerialize, nil
}

type NullableSingleRespResult struct {
	value *SingleRespResult
	isSet bool
}

func (v NullableSingleRespResult) Get() *SingleRespResult {
	return v.value
}

func (v *NullableSingleRespResult) Set(val *SingleRespResult) {
	v.value = val
	v.isSet = true
}
...
func NewNullableSingleRespResult(val *SingleRespResult) *NullableSingleRespResult {
	return &NullableSingleRespResult{value: val, isSet: true}
}
