...
// checks if the DetailedUdpAttributes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DetailedUdpAttributes{}
...
type NullableDetailedUdpAttributes struct {
	value *DetailedUdpAttributes
	isSet bool
}

func (v NullableDetailedUdpAttributes) Get() *DetailedUdpAttributes {
	return v.value
}

func (v *NullableDetailedUdpAttributes) Set(val *DetailedUdpAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullableDetailedUdpAttributes) IsSet() bool {
	return v.isSet
}
...
func NewNullableDetailedUdpAttributes(val *DetailedUdpAttributes) *NullableDetailedUdpAttributes {
	return &NullableDetailedUdpAttributes{value: val, isSet: true}
}
