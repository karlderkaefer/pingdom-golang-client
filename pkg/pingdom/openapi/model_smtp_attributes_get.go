...
// checks if the SmtpAttributesGet type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SmtpAttributesGet{}
...
type NullableSmtpAttributesGet struct {
	value *SmtpAttributesGet
	isSet bool
}

func (v NullableSmtpAttributesGet) Get() *SmtpAttributesGet {
	return v.value
}

func (v *NullableSmtpAttributesGet) Set(val *SmtpAttributesGet) {
	v.value = val
	v.isSet = true
}
...
func NewNullableSmtpAttributesGet(val *SmtpAttributesGet) *NullableSmtpAttributesGet {
	return &NullableSmtpAttributesGet{value: val, isSet: true}
}
