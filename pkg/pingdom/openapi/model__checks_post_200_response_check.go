...
// checks if the ChecksPost200ResponseCheck type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ChecksPost200ResponseCheck{}
...
func NewChecksPost200ResponseCheck() *ChecksPost200ResponseCheck {
	this := ChecksPost200ResponseCheck{}
	return &this
}
...
type NullableChecksPost200ResponseCheck struct {
	value *ChecksPost200ResponseCheck
	isSet bool
}

func (v NullableChecksPost200ResponseCheck) Get() *ChecksPost200ResponseCheck {
	return v.value
}

func (v *NullableChecksPost200ResponseCheck) Set(val *ChecksPost200ResponseCheck) {
	v.value = val
	v.isSet = true
}

func (v NullableChecksPost200ResponseCheck) IsSet() bool {
	return v.isSet
}

func (v *NullableChecksPost200ResponseCheck) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableChecksPost200ResponseCheck(val *ChecksPost200ResponseCheck) *NullableChecksPost200ResponseCheck {
	return &NullableChecksPost200ResponseCheck{value: val, isSet: true}
}
