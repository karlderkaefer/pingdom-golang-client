...
func (dst *DetailedCheck) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	// try to unmarshal data into DetailedCheckDns
	err = newStrictDecoder(data).Decode(&dst.DetailedCheckDns)
	if err == nil {
		jsonDetailedCheckDns, _ := json.Marshal(dst.DetailedCheckDns)
		if string(jsonDetailedCheckDns) == "{}" { // empty struct
			dst.DetailedCheckDns = nil
		} else {
			match++
		}
	} else {
	...
	// try to unmarshal data into DetailedCheckHttp
	err = newStrictDecoder(data).Decode(&dst.DetailedCheckHttp)
	if err == nil {
		jsonDetailedCheckHttp, _ := json.Marshal(dst.DetailedCheckHttp)
		if string(jsonDetailedCheckHttp) == "{}" { // empty struct
			dst.DetailedCheckHttp = nil
		} else {
			match++
		}
	} else {
	...
	// try to unmarshal data into DetailedCheckHttpCustom
	err = newStrictDecoder(data).Decode(&dst.DetailedCheckHttpCustom)
	if err == nil {
		jsonDetailedCheckHttpCustom, _ := json.Marshal(dst.DetailedCheckHttpCustom)
		if string(jsonDetailedCheckHttpCustom) == "{}" { // empty struct
			dst.DetailedCheckHttpCustom = nil
		} else {
			match++
		}
	} else {
	...
	// try to unmarshal data into DetailedCheckImap
	err = newStrictDecoder(data).Decode(&dst.DetailedCheckImap)
	if err == nil {
		jsonDetailedCheckImap, _ := json.Marshal(dst.DetailedCheckImap)
		if string(jsonDetailedCheckImap) == "{}" { // empty struct
			dst.DetailedCheckImap = nil
		} else {
			match++
		}
	} else {
	...
	// try to unmarshal data into DetailedCheckPop3
	err = newStrictDecoder(data).Decode(&dst.DetailedCheckPop3)
	if err == nil {
		jsonDetailedCheckPop3, _ := json.Marshal(dst.DetailedCheckPop3)
		if string(jsonDetailedCheckPop3) == "{}" { // empty struct
			dst.DetailedCheckPop3 = nil
		} else {
			match++
		}
	} else {
	...
	// try to unmarshal data into DetailedCheckSmtp
	err = newStrictDecoder(data).Decode(&dst.DetailedCheckSmtp)
	if err == nil {
		jsonDetailedCheckSmtp, _ := json.Marshal(dst.DetailedCheckSmtp)
		if string(jsonDetailedCheckSmtp) == "{}" { // empty struct
			dst.DetailedCheckSmtp = nil
		} else {
			match++
		}
	} else {
	...
	// try to unmarshal data into DetailedCheckTcp
	err = newStrictDecoder(data).Decode(&dst.DetailedCheckTcp)
	if err == nil {
		jsonDetailedCheckTcp, _ := json.Marshal(dst.DetailedCheckTcp)
		if string(jsonDetailedCheckTcp) == "{}" { // empty struct
			dst.DetailedCheckTcp = nil
		} else {
			match++
		}
	} else {
	...
	// try to unmarshal data into DetailedCheckUdp
	err = newStrictDecoder(data).Decode(&dst.DetailedCheckUdp)
	if err == nil {
		jsonDetailedCheckUdp, _ := json.Marshal(dst.DetailedCheckUdp)
		if string(jsonDetailedCheckUdp) == "{}" { // empty struct
			dst.DetailedCheckUdp = nil
		} else {
			match++
		}
	} else {
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("data matches more than one schema in oneOf(DetailedCheck)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("data failed to match schemas in oneOf(DetailedCheck)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src DetailedCheck) MarshalJSON() ([]byte, error) {
	if src.DetailedCheckDns != nil {
		return json.Marshal(&src.DetailedCheckDns)
	}

	if src.DetailedCheckHttp != nil {
		return json.Marshal(&src.DetailedCheckHttp)
	}

	if src.DetailedCheckHttpCustom != nil {
		return json.Marshal(&src.DetailedCheckHttpCustom)
	}

	if src.DetailedCheckImap != nil {
		return json.Marshal(&src.DetailedCheckImap)
	}

	if src.DetailedCheckPop3 != nil {
		return json.Marshal(&src.DetailedCheckPop3)
	}

	if src.DetailedCheckSmtp != nil {
		return json.Marshal(&src.DetailedCheckSmtp)
	}

	if src.DetailedCheckTcp != nil {
		return json.Marshal(&src.DetailedCheckTcp)
	}

	if src.DetailedCheckUdp != nil {
		return json.Marshal(&src.DetailedCheckUdp)
	}
...
func (obj *DetailedCheck) GetActualInstance() (interface{}) {
	...
	if obj.DetailedCheckDns != nil {
		return obj.DetailedCheckDns
	}

	if obj.DetailedCheckHttp != nil {
		return obj.DetailedCheckHttp
	}

	if obj.DetailedCheckHttpCustom != nil {
		return obj.DetailedCheckHttpCustom
	}

	if obj.DetailedCheckImap != nil {
		return obj.DetailedCheckImap
	}

	if obj.DetailedCheckPop3 != nil {
		return obj.DetailedCheckPop3
	}

	if obj.DetailedCheckSmtp != nil {
		return obj.DetailedCheckSmtp
	}

	if obj.DetailedCheckTcp != nil {
		return obj.DetailedCheckTcp
	}

	if obj.DetailedCheckUdp != nil {
		return obj.DetailedCheckUdp
	}
...
func (v NullableDetailedCheck) Get() *DetailedCheck {
	return v.value
}
...
func NewNullableDetailedCheck(val *DetailedCheck) *NullableDetailedCheck {
	return &NullableDetailedCheck{value: val, isSet: true}
}
