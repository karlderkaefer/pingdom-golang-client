...
// checks if the MaintenanceOccurrencesIdPut type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MaintenanceOccurrencesIdPut{}
...
func NewMaintenanceOccurrencesIdPut() *MaintenanceOccurrencesIdPut {
	this := MaintenanceOccurrencesIdPut{}
	return &this
}
...
type NullableMaintenanceOccurrencesIdPut struct {
	value *MaintenanceOccurrencesIdPut
	isSet bool
}

func (v NullableMaintenanceOccurrencesIdPut) Get() *MaintenanceOccurrencesIdPut {
	return v.value
}

func (v *NullableMaintenanceOccurrencesIdPut) Set(val *MaintenanceOccurrencesIdPut) {
	v.value = val
	v.isSet = true
}

func (v NullableMaintenanceOccurrencesIdPut) IsSet() bool {
	return v.isSet
}

func (v *NullableMaintenanceOccurrencesIdPut) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMaintenanceOccurrencesIdPut(val *MaintenanceOccurrencesIdPut) *NullableMaintenanceOccurrencesIdPut {
	return &NullableMaintenanceOccurrencesIdPut{value: val, isSet: true}
}
