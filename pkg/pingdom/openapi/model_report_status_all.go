...
// checks if the ReportStatusAll type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReportStatusAll{}
...
type NullableReportStatusAll struct {
	value *ReportStatusAll
	isSet bool
}

func (v NullableReportStatusAll) Get() *ReportStatusAll {
	return v.value
}

func (v *NullableReportStatusAll) Set(val *ReportStatusAll) {
	v.value = val
	v.isSet = true
}
...
func NewNullableReportStatusAll(val *ReportStatusAll) *NullableReportStatusAll {
	return &NullableReportStatusAll{value: val, isSet: true}
}
