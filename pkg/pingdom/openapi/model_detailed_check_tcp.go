...
// checks if the DetailedCheckTcp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DetailedCheckTcp{}
...
type NullableDetailedCheckTcp struct {
	value *DetailedCheckTcp
	isSet bool
}

func (v NullableDetailedCheckTcp) Get() *DetailedCheckTcp {
	return v.value
}

func (v *NullableDetailedCheckTcp) Set(val *DetailedCheckTcp) {
	v.value = val
	v.isSet = true
}
...
func NewNullableDetailedCheckTcp(val *DetailedCheckTcp) *NullableDetailedCheckTcp {
	return &NullableDetailedCheckTcp{value: val, isSet: true}
}
