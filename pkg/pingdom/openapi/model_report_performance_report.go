...
// checks if the ReportPerformanceReport type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReportPerformanceReport{}
...
func (o *ReportPerformanceReport) GetIntervals() []ReportPerformanceReportIntervalsInner {
	if o == nil || IsNil(o.Intervals) {
		var ret []ReportPerformanceReportIntervalsInner
		return ret
	}
	return o.Intervals
}
...
type NullableReportPerformanceReport struct {
	value *ReportPerformanceReport
	isSet bool
}

func (v NullableReportPerformanceReport) Get() *ReportPerformanceReport {
	return v.value
}

func (v *NullableReportPerformanceReport) Set(val *ReportPerformanceReport) {
	v.value = val
	v.isSet = true
}

func (v NullableReportPerformanceReport) IsSet() bool {
	return v.isSet
}

func (v *NullableReportPerformanceReport) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReportPerformanceReport(val *ReportPerformanceReport) *NullableReportPerformanceReport {
	return &NullableReportPerformanceReport{value: val, isSet: true}
}
