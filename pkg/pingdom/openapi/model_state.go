...
func (o *State) GetErrorInStep() int32 {
	if o == nil || IsNil(o.ErrorInStep) {
		var ret int32
		return ret
	}
	return *o.ErrorInStep
}

// GetErrorInStepOk returns a tuple with the ErrorInStep field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *State) GetErrorInStepOk() (*int32, bool) {
	if o == nil || IsNil(o.ErrorInStep) {
		return nil, false
	}
	return o.ErrorInStep, true
}
...
func (o State) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ErrorInStep) {
		toSerialize["error_in_step"] = o.ErrorInStep
	}
	if !IsNil(o.Message) {
