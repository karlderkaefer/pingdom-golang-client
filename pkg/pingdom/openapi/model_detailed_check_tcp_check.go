...
// checks if the DetailedCheckTcpCheck type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DetailedCheckTcpCheck{}
...
type NullableDetailedCheckTcpCheck struct {
	value *DetailedCheckTcpCheck
	isSet bool
}

func (v NullableDetailedCheckTcpCheck) Get() *DetailedCheckTcpCheck {
	return v.value
}

func (v *NullableDetailedCheckTcpCheck) Set(val *DetailedCheckTcpCheck) {
	v.value = val
	v.isSet = true
}

func (v NullableDetailedCheckTcpCheck) IsSet() bool {
	return v.isSet
}
...
func NewNullableDetailedCheckTcpCheck(val *DetailedCheckTcpCheck) *NullableDetailedCheckTcpCheck {
	return &NullableDetailedCheckTcpCheck{value: val, isSet: true}
}
