...
// checks if the SummaryRespAttrs type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SummaryRespAttrs{}
...
func (o *SummaryRespAttrs) GetSummary() SummaryRespAttrsSummary {
	if o == nil || IsNil(o.Summary) {
		var ret SummaryRespAttrsSummary
		return ret
	}
	return *o.Summary
}
...
type NullableSummaryRespAttrs struct {
	value *SummaryRespAttrs
	isSet bool
}

func (v NullableSummaryRespAttrs) Get() *SummaryRespAttrs {
	return v.value
}

func (v *NullableSummaryRespAttrs) Set(val *SummaryRespAttrs) {
	v.value = val
	v.isSet = true
}
...
func NewNullableSummaryRespAttrs(val *SummaryRespAttrs) *NullableSummaryRespAttrs {
	return &NullableSummaryRespAttrs{value: val, isSet: true}
}
