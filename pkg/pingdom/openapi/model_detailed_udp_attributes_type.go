...
// checks if the DetailedUdpAttributesType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DetailedUdpAttributesType{}
...
func NewDetailedUdpAttributesType() *DetailedUdpAttributesType {
	this := DetailedUdpAttributesType{}
	return &this
}
...
type NullableDetailedUdpAttributesType struct {
	value *DetailedUdpAttributesType
	isSet bool
}

func (v NullableDetailedUdpAttributesType) Get() *DetailedUdpAttributesType {
	return v.value
}

func (v *NullableDetailedUdpAttributesType) Set(val *DetailedUdpAttributesType) {
	v.value = val
	v.isSet = true
}

func (v NullableDetailedUdpAttributesType) IsSet() bool {
	return v.isSet
}

func (v *NullableDetailedUdpAttributesType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDetailedUdpAttributesType(val *DetailedUdpAttributesType) *NullableDetailedUdpAttributesType {
	return &NullableDetailedUdpAttributesType{value: val, isSet: true}
}
