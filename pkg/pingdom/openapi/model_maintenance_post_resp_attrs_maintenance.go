...
// checks if the MaintenancePostRespAttrsMaintenance type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MaintenancePostRespAttrsMaintenance{}
...
func NewMaintenancePostRespAttrsMaintenance() *MaintenancePostRespAttrsMaintenance {
	this := MaintenancePostRespAttrsMaintenance{}
	return &this
}
...
type NullableMaintenancePostRespAttrsMaintenance struct {
	value *MaintenancePostRespAttrsMaintenance
	isSet bool
}

func (v NullableMaintenancePostRespAttrsMaintenance) Get() *MaintenancePostRespAttrsMaintenance {
	return v.value
}

func (v *NullableMaintenancePostRespAttrsMaintenance) Set(val *MaintenancePostRespAttrsMaintenance) {
	v.value = val
	v.isSet = true
}

func (v NullableMaintenancePostRespAttrsMaintenance) IsSet() bool {
	return v.isSet
}

func (v *NullableMaintenancePostRespAttrsMaintenance) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMaintenancePostRespAttrsMaintenance(val *MaintenancePostRespAttrsMaintenance) *NullableMaintenancePostRespAttrsMaintenance {
	return &NullableMaintenancePostRespAttrsMaintenance{value: val, isSet: true}
}

func (v NullableMaintenancePostRespAttrsMaintenance) MarshalJSON() ([]byte, error) {
