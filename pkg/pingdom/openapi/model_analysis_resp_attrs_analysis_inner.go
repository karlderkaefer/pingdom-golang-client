...
// checks if the AnalysisRespAttrsAnalysisInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AnalysisRespAttrsAnalysisInner{}
...
func NewAnalysisRespAttrsAnalysisInner() *AnalysisRespAttrsAnalysisInner {
	this := AnalysisRespAttrsAnalysisInner{}
	return &this
}
...
func (o *AnalysisRespAttrsAnalysisInner) GetTimefirsttest() int32 {
	if o == nil || IsNil(o.Timefirsttest) {
		var ret int32
		return ret
	}
	return *o.Timefirsttest
}

// GetTimefirsttestOk returns a tuple with the Timefirsttest field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AnalysisRespAttrsAnalysisInner) GetTimefirsttestOk() (*int32, bool) {
	if o == nil || IsNil(o.Timefirsttest) {
		return nil, false
	}
	return o.Timefirsttest, true
}
...
func (o *AnalysisRespAttrsAnalysisInner) GetTimeconfirmtest() int32 {
	if o == nil || IsNil(o.Timeconfirmtest) {
		var ret int32
		return ret
	}
	return *o.Timeconfirmtest
}

// GetTimeconfirmtestOk returns a tuple with the Timeconfirmtest field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AnalysisRespAttrsAnalysisInner) GetTimeconfirmtestOk() (*int32, bool) {
	if o == nil || IsNil(o.Timeconfirmtest) {
		return nil, false
	}
	return o.Timeconfirmtest, true
}
...
func (o AnalysisRespAttrsAnalysisInner) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.Timefirsttest) {
		toSerialize["timefirsttest"] = o.Timefirsttest
	}
	if !IsNil(o.Timeconfirmtest) {
		toSerialize["timeconfirmtest"] = o.Timeconfirmtest
	}
	return toSerialize, nil
}

type NullableAnalysisRespAttrsAnalysisInner struct {
	value *AnalysisRespAttrsAnalysisInner
	isSet bool
}

func (v NullableAnalysisRespAttrsAnalysisInner) Get() *AnalysisRespAttrsAnalysisInner {
	return v.value
}

func (v *NullableAnalysisRespAttrsAnalysisInner) Set(val *AnalysisRespAttrsAnalysisInner) {
	v.value = val
	v.isSet = true
}

func (v NullableAnalysisRespAttrsAnalysisInner) IsSet() bool {
	return v.isSet
}

func (v *NullableAnalysisRespAttrsAnalysisInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAnalysisRespAttrsAnalysisInner(val *AnalysisRespAttrsAnalysisInner) *NullableAnalysisRespAttrsAnalysisInner {
	return &NullableAnalysisRespAttrsAnalysisInner{value: val, isSet: true}
}
