...
// checks if the ReportStatusSingle type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReportStatusSingle{}
...
type NullableReportStatusSingle struct {
	value *ReportStatusSingle
	isSet bool
}

func (v NullableReportStatusSingle) Get() *ReportStatusSingle {
	return v.value
}

func (v *NullableReportStatusSingle) Set(val *ReportStatusSingle) {
	v.value = val
	v.isSet = true
}
...
func NewNullableReportStatusSingle(val *ReportStatusSingle) *NullableReportStatusSingle {
	return &NullableReportStatusSingle{value: val, isSet: true}
}
