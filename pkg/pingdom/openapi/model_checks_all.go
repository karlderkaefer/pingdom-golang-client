...
// checks if the ChecksAll type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ChecksAll{}
...
func NewNullableChecksAll(val *ChecksAll) *NullableChecksAll {
	return &NullableChecksAll{value: val, isSet: true}
}
