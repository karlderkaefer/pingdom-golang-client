...
// checks if the MaintenanceDelete type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MaintenanceDelete{}
...
type _MaintenanceDelete MaintenanceDelete
...
func (o *MaintenanceDelete) GetMaintenanceids() []int32 {
	...
	return o.Maintenanceids
}

// GetMaintenanceidsOk returns a tuple with the Maintenanceids field value
// and a boolean to check if the value has been set.
func (o *MaintenanceDelete) GetMaintenanceidsOk() ([]int32, bool) {
	if o == nil {
		return nil, false
	}
	return o.Maintenanceids, true
}
...
func (o MaintenanceDelete) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["maintenanceids"] = o.Maintenanceids
...
func (o *MaintenanceDelete) UnmarshalJSON(data []byte) (err error) {
	...
	varMaintenanceDelete := _MaintenanceDelete{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMaintenanceDelete)

	if err != nil {
		return err
	}

	*o = MaintenanceDelete(varMaintenanceDelete)

	return err
}

type NullableMaintenanceDelete struct {
	value *MaintenanceDelete
	isSet bool
}

func (v NullableMaintenanceDelete) Get() *MaintenanceDelete {
	return v.value
}

func (v *NullableMaintenanceDelete) Set(val *MaintenanceDelete) {
	v.value = val
	v.isSet = true
}
...
func NewNullableMaintenanceDelete(val *MaintenanceDelete) *NullableMaintenanceDelete {
	return &NullableMaintenanceDelete{value: val, isSet: true}
}
