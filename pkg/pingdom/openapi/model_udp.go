...
// checks if the UDP type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UDP{}
...
func NewNullableUDP(val *UDP) *NullableUDP {
	return &NullableUDP{value: val, isSet: true}
}
