...
// checks if the MaintenancePostRespAttrs type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MaintenancePostRespAttrs{}
...
func (o *MaintenancePostRespAttrs) GetMaintenance() MaintenancePostRespAttrsMaintenance {
	if o == nil || IsNil(o.Maintenance) {
		var ret MaintenancePostRespAttrsMaintenance
		return ret
	}
...
type NullableMaintenancePostRespAttrs struct {
	value *MaintenancePostRespAttrs
	isSet bool
}

func (v NullableMaintenancePostRespAttrs) Get() *MaintenancePostRespAttrs {
	return v.value
}

func (v *NullableMaintenancePostRespAttrs) Set(val *MaintenancePostRespAttrs) {
	v.value = val
	v.isSet = true
}

func (v NullableMaintenancePostRespAttrs) IsSet() bool {
	return v.isSet
}

func (v *NullableMaintenancePostRespAttrs) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMaintenancePostRespAttrs(val *MaintenancePostRespAttrs) *NullableMaintenancePostRespAttrs {
	return &NullableMaintenancePostRespAttrs{value: val, isSet: true}
}
