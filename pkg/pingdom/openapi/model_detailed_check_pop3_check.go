...
// checks if the DetailedCheckPop3Check type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DetailedCheckPop3Check{}
...
func (o *DetailedCheckPop3Check) GetType() DetailedPop3AttributesType {
	if o == nil || IsNil(o.Type) {
		var ret DetailedPop3AttributesType
		return ret
	}
	return *o.Type
}
...
type NullableDetailedCheckPop3Check struct {
	value *DetailedCheckPop3Check
	isSet bool
}

func (v NullableDetailedCheckPop3Check) Get() *DetailedCheckPop3Check {
	return v.value
}

func (v *NullableDetailedCheckPop3Check) Set(val *DetailedCheckPop3Check) {
	v.value = val
	v.isSet = true
}

func (v NullableDetailedCheckPop3Check) IsSet() bool {
	return v.isSet
}
...
func NewNullableDetailedCheckPop3Check(val *DetailedCheckPop3Check) *NullableDetailedCheckPop3Check {
	return &NullableDetailedCheckPop3Check{value: val, isSet: true}
}
