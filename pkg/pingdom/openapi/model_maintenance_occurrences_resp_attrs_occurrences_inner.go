...
// checks if the MaintenanceOccurrencesRespAttrsOccurrencesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MaintenanceOccurrencesRespAttrsOccurrencesInner{}
...
func NewMaintenanceOccurrencesRespAttrsOccurrencesInner() *MaintenanceOccurrencesRespAttrsOccurrencesInner {
	this := MaintenanceOccurrencesRespAttrsOccurrencesInner{}
	return &this
}
...
func (o MaintenanceOccurrencesRespAttrsOccurrencesInner) MarshalJSON() ([]byte, error) {
...
type NullableMaintenanceOccurrencesRespAttrsOccurrencesInner struct {
	value *MaintenanceOccurrencesRespAttrsOccurrencesInner
	isSet bool
}

func (v NullableMaintenanceOccurrencesRespAttrsOccurrencesInner) Get() *MaintenanceOccurrencesRespAttrsOccurrencesInner {
	return v.value
}

func (v *NullableMaintenanceOccurrencesRespAttrsOccurrencesInner) Set(val *MaintenanceOccurrencesRespAttrsOccurrencesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableMaintenanceOccurrencesRespAttrsOccurrencesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableMaintenanceOccurrencesRespAttrsOccurrencesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMaintenanceOccurrencesRespAttrsOccurrencesInner(val *MaintenanceOccurrencesRespAttrsOccurrencesInner) *NullableMaintenanceOccurrencesRespAttrsOccurrencesInner {
	return &NullableMaintenanceOccurrencesRespAttrsOccurrencesInner{value: val, isSet: true}
}

func (v NullableMaintenanceOccurrencesRespAttrsOccurrencesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMaintenanceOccurrencesRespAttrsOccurrencesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
