...
// checks if the UdpAttributes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UdpAttributes{}
...
type _UdpAttributes UdpAttributes
...
// GetStringtosendOk returns a tuple with the Stringtosend field value
// and a boolean to check if the value has been set.
...
// GetStringtoexpectOk returns a tuple with the Stringtoexpect field value
// and a boolean to check if the value has been set.
...
func (o *UdpAttributes) UnmarshalJSON(data []byte) (err error) {
	...
	varUdpAttributes := _UdpAttributes{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUdpAttributes)

	if err != nil {
		return err
	}

	*o = UdpAttributes(varUdpAttributes)
...
func (v NullableUdpAttributes) Get() *UdpAttributes {
	return v.value
}
...
func NewNullableUdpAttributes(val *UdpAttributes) *NullableUdpAttributes {
	return &NullableUdpAttributes{value: val, isSet: true}
}
