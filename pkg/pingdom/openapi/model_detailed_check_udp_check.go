...
// checks if the DetailedCheckUdpCheck type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DetailedCheckUdpCheck{}
...
func (o *DetailedCheckUdpCheck) GetType() DetailedUdpAttributesType {
	if o == nil || IsNil(o.Type) {
		var ret DetailedUdpAttributesType
		return ret
	}
	return *o.Type
}
...
type NullableDetailedCheckUdpCheck struct {
	value *DetailedCheckUdpCheck
	isSet bool
}

func (v NullableDetailedCheckUdpCheck) Get() *DetailedCheckUdpCheck {
	return v.value
}

func (v *NullableDetailedCheckUdpCheck) Set(val *DetailedCheckUdpCheck) {
	v.value = val
	v.isSet = true
}

func (v NullableDetailedCheckUdpCheck) IsSet() bool {
	return v.isSet
}
...
func NewNullableDetailedCheckUdpCheck(val *DetailedCheckUdpCheck) *NullableDetailedCheckUdpCheck {
	return &NullableDetailedCheckUdpCheck{value: val, isSet: true}
}
