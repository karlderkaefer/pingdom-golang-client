...
// checks if the ResultsRespAttrs type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResultsRespAttrs{}
...
func (o *ResultsRespAttrs) GetResults() []ResultsRespAttrsResultsInner {
	if o == nil || IsNil(o.Results) {
		var ret []ResultsRespAttrsResultsInner
		return ret
	}
	return o.Results
}
...
func (o *ResultsRespAttrs) GetActiveprobes() []float32 {
	if o == nil || IsNil(o.Activeprobes) {
		var ret []float32
		return ret
	}
	return o.Activeprobes
}

// GetActiveprobesOk returns a tuple with the Activeprobes field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ResultsRespAttrs) GetActiveprobesOk() ([]float32, bool) {
	if o == nil || IsNil(o.Activeprobes) {
		return nil, false
	}
	return o.Activeprobes, true
}
...
func (o ResultsRespAttrs) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.Activeprobes) {
		toSerialize["activeprobes"] = o.Activeprobes
	}
	return toSerialize, nil
}

type NullableResultsRespAttrs struct {
	value *ResultsRespAttrs
	isSet bool
}

func (v NullableResultsRespAttrs) Get() *ResultsRespAttrs {
	return v.value
}

func (v *NullableResultsRespAttrs) Set(val *ResultsRespAttrs) {
	v.value = val
	v.isSet = true
}
...
func NewNullableResultsRespAttrs(val *ResultsRespAttrs) *NullableResultsRespAttrs {
	return &NullableResultsRespAttrs{value: val, isSet: true}
}
