...
// checks if the TeamID type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TeamID{}
...
func NewNullableTeamID(val *TeamID) *NullableTeamID {
	return &NullableTeamID{value: val, isSet: true}
}
