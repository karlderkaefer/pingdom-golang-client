...
// checks if the SummaryOutageRespAttrs type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SummaryOutageRespAttrs{}
...
func (o *SummaryOutageRespAttrs) GetSummary() SummaryOutageRespAttrsSummary {
	if o == nil || IsNil(o.Summary) {
		var ret SummaryOutageRespAttrsSummary
		return ret
	}
	return *o.Summary
}
...
type NullableSummaryOutageRespAttrs struct {
	value *SummaryOutageRespAttrs
	isSet bool
}

func (v NullableSummaryOutageRespAttrs) Get() *SummaryOutageRespAttrs {
	return v.value
}

func (v *NullableSummaryOutageRespAttrs) Set(val *SummaryOutageRespAttrs) {
	v.value = val
	v.isSet = true
}

func (v NullableSummaryOutageRespAttrs) IsSet() bool {
	return v.isSet
}
...
func NewNullableSummaryOutageRespAttrs(val *SummaryOutageRespAttrs) *NullableSummaryOutageRespAttrs {
	return &NullableSummaryOutageRespAttrs{value: val, isSet: true}
}
