...
// checks if the Weeks type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Weeks{}
...
func (o *Weeks) GetWeeks() []SummaryPerformanceResultsInner {
	if o == nil || IsNil(o.Weeks) {
		var ret []SummaryPerformanceResultsInner
		return ret
	}
	return o.Weeks
}
...
func NewNullableWeeks(val *Weeks) *NullableWeeks {
	return &NullableWeeks{value: val, isSet: true}
}
