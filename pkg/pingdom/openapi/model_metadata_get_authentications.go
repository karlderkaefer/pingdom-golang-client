...
// checks if the MetadataGETAuthentications type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MetadataGETAuthentications{}
...
func NewMetadataGETAuthentications() *MetadataGETAuthentications {
	this := MetadataGETAuthentications{}
	return &this
}
...
func (o *MetadataGETAuthentications) GetHttpAuthentications() []HttpAuthentications {
	if o == nil || IsNil(o.HttpAuthentications) {
		var ret []HttpAuthentications
		return ret
	}
	return o.HttpAuthentications
}

// GetHttpAuthenticationsOk returns a tuple with the HttpAuthentications field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MetadataGETAuthentications) GetHttpAuthenticationsOk() ([]HttpAuthentications, bool) {
	if o == nil || IsNil(o.HttpAuthentications) {
		return nil, false
	}
	return o.HttpAuthentications, true
}
...
func (o MetadataGETAuthentications) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.HttpAuthentications) {
		toSerialize["httpAuthentications"] = o.HttpAuthentications
	}
	return toSerialize, nil
}

type NullableMetadataGETAuthentications struct {
	value *MetadataGETAuthentications
	isSet bool
}

func (v NullableMetadataGETAuthentications) Get() *MetadataGETAuthentications {
	return v.value
}

func (v *NullableMetadataGETAuthentications) Set(val *MetadataGETAuthentications) {
	v.value = val
	v.isSet = true
}

func (v NullableMetadataGETAuthentications) IsSet() bool {
	return v.isSet
}

func (v *NullableMetadataGETAuthentications) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMetadataGETAuthentications(val *MetadataGETAuthentications) *NullableMetadataGETAuthentications {
	return &NullableMetadataGETAuthentications{value: val, isSet: true}
}
