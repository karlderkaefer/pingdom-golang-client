...
// checks if the CreditsRespAttrs type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreditsRespAttrs{}
...
func (o *CreditsRespAttrs) GetCredits() CreditsRespAttrsCredits {
	if o == nil || IsNil(o.Credits) {
		var ret CreditsRespAttrsCredits
		return ret
	}
	return *o.Credits
}
...
type NullableCreditsRespAttrs struct {
	value *CreditsRespAttrs
	isSet bool
}

func (v NullableCreditsRespAttrs) Get() *CreditsRespAttrs {
	return v.value
}

func (v *NullableCreditsRespAttrs) Set(val *CreditsRespAttrs) {
	v.value = val
	v.isSet = true
}
...
func NewNullableCreditsRespAttrs(val *CreditsRespAttrs) *NullableCreditsRespAttrs {
	return &NullableCreditsRespAttrs{value: val, isSet: true}
}
