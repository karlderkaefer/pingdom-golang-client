...
// checks if the SMSesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SMSesInner{}
...
func NewNullableSMSesInner(val *SMSesInner) *NullableSMSesInner {
	return &NullableSMSesInner{value: val, isSet: true}
}
