...
// checks if the DetailedTcpAttributesType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DetailedTcpAttributesType{}
...
func NewDetailedTcpAttributesType() *DetailedTcpAttributesType {
	this := DetailedTcpAttributesType{}
	return &this
}
...
type NullableDetailedTcpAttributesType struct {
	value *DetailedTcpAttributesType
	isSet bool
}

func (v NullableDetailedTcpAttributesType) Get() *DetailedTcpAttributesType {
	return v.value
}

func (v *NullableDetailedTcpAttributesType) Set(val *DetailedTcpAttributesType) {
	v.value = val
	v.isSet = true
}

func (v NullableDetailedTcpAttributesType) IsSet() bool {
	return v.isSet
}

func (v *NullableDetailedTcpAttributesType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDetailedTcpAttributesType(val *DetailedTcpAttributesType) *NullableDetailedTcpAttributesType {
	return &NullableDetailedTcpAttributesType{value: val, isSet: true}
}
