...
// checks if the SmtpAttributesBase type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SmtpAttributesBase{}
...
type NullableSmtpAttributesBase struct {
	value *SmtpAttributesBase
	isSet bool
}

func (v NullableSmtpAttributesBase) Get() *SmtpAttributesBase {
	return v.value
}

func (v *NullableSmtpAttributesBase) Set(val *SmtpAttributesBase) {
	v.value = val
	v.isSet = true
}
...
func NewNullableSmtpAttributesBase(val *SmtpAttributesBase) *NullableSmtpAttributesBase {
	return &NullableSmtpAttributesBase{value: val, isSet: true}
}
