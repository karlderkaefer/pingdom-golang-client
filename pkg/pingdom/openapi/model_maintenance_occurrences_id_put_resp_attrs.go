...
// checks if the MaintenanceOccurrencesIdPutRespAttrs type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MaintenanceOccurrencesIdPutRespAttrs{}
...
func NewMaintenanceOccurrencesIdPutRespAttrs() *MaintenanceOccurrencesIdPutRespAttrs {
	this := MaintenanceOccurrencesIdPutRespAttrs{}
	return &this
}
...
type NullableMaintenanceOccurrencesIdPutRespAttrs struct {
	value *MaintenanceOccurrencesIdPutRespAttrs
	isSet bool
}

func (v NullableMaintenanceOccurrencesIdPutRespAttrs) Get() *MaintenanceOccurrencesIdPutRespAttrs {
	return v.value
}

func (v *NullableMaintenanceOccurrencesIdPutRespAttrs) Set(val *MaintenanceOccurrencesIdPutRespAttrs) {
	v.value = val
	v.isSet = true
}

func (v NullableMaintenanceOccurrencesIdPutRespAttrs) IsSet() bool {
	return v.isSet
}

func (v *NullableMaintenanceOccurrencesIdPutRespAttrs) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMaintenanceOccurrencesIdPutRespAttrs(val *MaintenanceOccurrencesIdPutRespAttrs) *NullableMaintenanceOccurrencesIdPutRespAttrs {
	return &NullableMaintenanceOccurrencesIdPutRespAttrs{value: val, isSet: true}
}

func (v NullableMaintenanceOccurrencesIdPutRespAttrs) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMaintenanceOccurrencesIdPutRespAttrs) UnmarshalJSON(src []byte) error {
	v.isSet = true
