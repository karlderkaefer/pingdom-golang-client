...
func (r ApiReferenceGetRequest) Execute() (*References, *http.Response, error) {
...
*/
func (a *ReferenceAPIService) ReferenceGet(ctx context.Context) ApiReferenceGetRequest {
	return ApiReferenceGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *ReferenceAPIService) ReferenceGetExecute(r ApiReferenceGetRequest) (*References, *http.Response, error) {
	var (
		...
		formFiles            []formFile
		localVarReturnValue  *References
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ReferenceAPIService.ReferenceGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/reference"
