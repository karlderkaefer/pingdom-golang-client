...
// checks if the DeleteCheck200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeleteCheck200Response{}
...
type NullableDeleteCheck200Response struct {
	value *DeleteCheck200Response
	isSet bool
}

func (v NullableDeleteCheck200Response) Get() *DeleteCheck200Response {
	return v.value
}

func (v *NullableDeleteCheck200Response) Set(val *DeleteCheck200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableDeleteCheck200Response) IsSet() bool {
	return v.isSet
}
...
func NewNullableDeleteCheck200Response(val *DeleteCheck200Response) *NullableDeleteCheck200Response {
	return &NullableDeleteCheck200Response{value: val, isSet: true}
}
