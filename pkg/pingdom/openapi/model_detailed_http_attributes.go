...
// checks if the DetailedHttpAttributes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DetailedHttpAttributes{}
...
type NullableDetailedHttpAttributes struct {
	value *DetailedHttpAttributes
	isSet bool
}

func (v NullableDetailedHttpAttributes) Get() *DetailedHttpAttributes {
	return v.value
}

func (v *NullableDetailedHttpAttributes) Set(val *DetailedHttpAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullableDetailedHttpAttributes) IsSet() bool {
	return v.isSet
}
...
func NewNullableDetailedHttpAttributes(val *DetailedHttpAttributes) *NullableDetailedHttpAttributes {
	return &NullableDetailedHttpAttributes{value: val, isSet: true}
}
