...
// checks if the SummaryProbesRespAttrs type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SummaryProbesRespAttrs{}
...
type NullableSummaryProbesRespAttrs struct {
	value *SummaryProbesRespAttrs
	isSet bool
}

func (v NullableSummaryProbesRespAttrs) Get() *SummaryProbesRespAttrs {
	return v.value
}

func (v *NullableSummaryProbesRespAttrs) Set(val *SummaryProbesRespAttrs) {
	v.value = val
	v.isSet = true
}

func (v NullableSummaryProbesRespAttrs) IsSet() bool {
	return v.isSet
}
...
func NewNullableSummaryProbesRespAttrs(val *SummaryProbesRespAttrs) *NullableSummaryProbesRespAttrs {
	return &NullableSummaryProbesRespAttrs{value: val, isSet: true}
}
