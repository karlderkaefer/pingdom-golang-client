...
// checks if the DetailedHttpCustomAttributes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DetailedHttpCustomAttributes{}
...
func NewDetailedHttpCustomAttributes() *DetailedHttpCustomAttributes {
	this := DetailedHttpCustomAttributes{}
	return &this
}
...
type NullableDetailedHttpCustomAttributes struct {
	value *DetailedHttpCustomAttributes
	isSet bool
}

func (v NullableDetailedHttpCustomAttributes) Get() *DetailedHttpCustomAttributes {
	return v.value
}

func (v *NullableDetailedHttpCustomAttributes) Set(val *DetailedHttpCustomAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullableDetailedHttpCustomAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullableDetailedHttpCustomAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDetailedHttpCustomAttributes(val *DetailedHttpCustomAttributes) *NullableDetailedHttpCustomAttributes {
	return &NullableDetailedHttpCustomAttributes{value: val, isSet: true}
}
