...
// checks if the DnsAttributes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DnsAttributes{}
...
type _DnsAttributes DnsAttributes
...
// GetExpectedipOk returns a tuple with the Expectedip field value
// and a boolean to check if the value has been set.
func (o *DnsAttributes) GetExpectedipOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Expectedip, true
}
...
func (o DnsAttributes) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["expectedip"] = o.Expectedip
...
func (o *DnsAttributes) UnmarshalJSON(data []byte) (err error) {
	...
	varDnsAttributes := _DnsAttributes{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDnsAttributes)

	if err != nil {
		return err
	}

	*o = DnsAttributes(varDnsAttributes)
...
func (v NullableDnsAttributes) Get() *DnsAttributes {
	return v.value
}
...
func NewNullableDnsAttributes(val *DnsAttributes) *NullableDnsAttributes {
	return &NullableDnsAttributes{value: val, isSet: true}
}
