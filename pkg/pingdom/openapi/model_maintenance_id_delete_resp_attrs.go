...
// checks if the MaintenanceIdDeleteRespAttrs type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MaintenanceIdDeleteRespAttrs{}
...
func NewMaintenanceIdDeleteRespAttrs() *MaintenanceIdDeleteRespAttrs {
	this := MaintenanceIdDeleteRespAttrs{}
	return &this
}
...
type NullableMaintenanceIdDeleteRespAttrs struct {
	value *MaintenanceIdDeleteRespAttrs
	isSet bool
}

func (v NullableMaintenanceIdDeleteRespAttrs) Get() *MaintenanceIdDeleteRespAttrs {
	return v.value
}

func (v *NullableMaintenanceIdDeleteRespAttrs) Set(val *MaintenanceIdDeleteRespAttrs) {
	v.value = val
	v.isSet = true
}

func (v NullableMaintenanceIdDeleteRespAttrs) IsSet() bool {
	return v.isSet
}

func (v *NullableMaintenanceIdDeleteRespAttrs) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMaintenanceIdDeleteRespAttrs(val *MaintenanceIdDeleteRespAttrs) *NullableMaintenanceIdDeleteRespAttrs {
	return &NullableMaintenanceIdDeleteRespAttrs{value: val, isSet: true}
}
