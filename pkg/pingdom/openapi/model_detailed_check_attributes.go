...
// checks if the DetailedCheckAttributes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DetailedCheckAttributes{}
...
type NullableDetailedCheckAttributes struct {
	value *DetailedCheckAttributes
	isSet bool
}

func (v NullableDetailedCheckAttributes) Get() *DetailedCheckAttributes {
	return v.value
}

func (v *NullableDetailedCheckAttributes) Set(val *DetailedCheckAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullableDetailedCheckAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullableDetailedCheckAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDetailedCheckAttributes(val *DetailedCheckAttributes) *NullableDetailedCheckAttributes {
	return &NullableDetailedCheckAttributes{value: val, isSet: true}
}
