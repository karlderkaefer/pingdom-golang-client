...
// checks if the DetailedImapAttributesType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DetailedImapAttributesType{}
...
func NewDetailedImapAttributesType() *DetailedImapAttributesType {
	this := DetailedImapAttributesType{}
	return &this
}
...
type NullableDetailedImapAttributesType struct {
	value *DetailedImapAttributesType
	isSet bool
}

func (v NullableDetailedImapAttributesType) Get() *DetailedImapAttributesType {
	return v.value
}

func (v *NullableDetailedImapAttributesType) Set(val *DetailedImapAttributesType) {
	v.value = val
	v.isSet = true
}

func (v NullableDetailedImapAttributesType) IsSet() bool {
	return v.isSet
}

func (v *NullableDetailedImapAttributesType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDetailedImapAttributesType(val *DetailedImapAttributesType) *NullableDetailedImapAttributesType {
	return &NullableDetailedImapAttributesType{value: val, isSet: true}
}
