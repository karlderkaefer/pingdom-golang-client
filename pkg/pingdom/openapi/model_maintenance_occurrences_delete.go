...
// checks if the MaintenanceOccurrencesDelete type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MaintenanceOccurrencesDelete{}
...
type _MaintenanceOccurrencesDelete MaintenanceOccurrencesDelete
...
func NewMaintenanceOccurrencesDelete(occurrenceids []int32) *MaintenanceOccurrencesDelete {
	this := MaintenanceOccurrencesDelete{}
...
// GetOccurrenceidsOk returns a tuple with the Occurrenceids field value
...
func (o *MaintenanceOccurrencesDelete) UnmarshalJSON(data []byte) (err error) {
	...
	varMaintenanceOccurrencesDelete := _MaintenanceOccurrencesDelete{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMaintenanceOccurrencesDelete)

	if err != nil {
		return err
	}

	*o = MaintenanceOccurrencesDelete(varMaintenanceOccurrencesDelete)

	return err
}

type NullableMaintenanceOccurrencesDelete struct {
	value *MaintenanceOccurrencesDelete
	isSet bool
}

func (v NullableMaintenanceOccurrencesDelete) Get() *MaintenanceOccurrencesDelete {
	return v.value
}

func (v *NullableMaintenanceOccurrencesDelete) Set(val *MaintenanceOccurrencesDelete) {
	v.value = val
	v.isSet = true
}

func (v NullableMaintenanceOccurrencesDelete) IsSet() bool {
	return v.isSet
}

func (v *NullableMaintenanceOccurrencesDelete) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMaintenanceOccurrencesDelete(val *MaintenanceOccurrencesDelete) *NullableMaintenanceOccurrencesDelete {
	return &NullableMaintenanceOccurrencesDelete{value: val, isSet: true}
}
