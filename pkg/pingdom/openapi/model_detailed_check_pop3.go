...
// checks if the DetailedCheckPop3 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DetailedCheckPop3{}
...
func (o *DetailedCheckPop3) GetCheck() DetailedCheckPop3Check {
	if o == nil || IsNil(o.Check) {
		var ret DetailedCheckPop3Check
		return ret
	}
	return *o.Check
}
...
type NullableDetailedCheckPop3 struct {
	value *DetailedCheckPop3
	isSet bool
}

func (v NullableDetailedCheckPop3) Get() *DetailedCheckPop3 {
	return v.value
}

func (v *NullableDetailedCheckPop3) Set(val *DetailedCheckPop3) {
	v.value = val
	v.isSet = true
}
...
func NewNullableDetailedCheckPop3(val *DetailedCheckPop3) *NullableDetailedCheckPop3 {
	return &NullableDetailedCheckPop3{value: val, isSet: true}
}
