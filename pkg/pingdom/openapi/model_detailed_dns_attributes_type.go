...
// checks if the DetailedDnsAttributesType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DetailedDnsAttributesType{}
...
func NewDetailedDnsAttributesType() *DetailedDnsAttributesType {
	this := DetailedDnsAttributesType{}
	return &this
}
...
type NullableDetailedDnsAttributesType struct {
	value *DetailedDnsAttributesType
	isSet bool
}

func (v NullableDetailedDnsAttributesType) Get() *DetailedDnsAttributesType {
	return v.value
}

func (v *NullableDetailedDnsAttributesType) Set(val *DetailedDnsAttributesType) {
	v.value = val
	v.isSet = true
}

func (v NullableDetailedDnsAttributesType) IsSet() bool {
	return v.isSet
}

func (v *NullableDetailedDnsAttributesType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDetailedDnsAttributesType(val *DetailedDnsAttributesType) *NullableDetailedDnsAttributesType {
	return &NullableDetailedDnsAttributesType{value: val, isSet: true}
}
