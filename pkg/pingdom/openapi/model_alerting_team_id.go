...
// checks if the AlertingTeamID type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AlertingTeamID{}
...
type NullableAlertingTeamID struct {
	value *AlertingTeamID
	isSet bool
}

func (v NullableAlertingTeamID) Get() *AlertingTeamID {
	return v.value
}

func (v *NullableAlertingTeamID) Set(val *AlertingTeamID) {
	v.value = val
	v.isSet = true
}
...
func NewNullableAlertingTeamID(val *AlertingTeamID) *NullableAlertingTeamID {
	return &NullableAlertingTeamID{value: val, isSet: true}
}
