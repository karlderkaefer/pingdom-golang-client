...
func (r ApiProbesGetRequest) Limit(limit int32) ApiProbesGetRequest {
	r.limit = &limit
	return r
}

// Offset for listing. (Requires limit.)
func (r ApiProbesGetRequest) Offset(offset int32) ApiProbesGetRequest {
	r.offset = &offset
	return r
}
...
func (r ApiProbesGetRequest) Execute() (*Probes, *http.Response, error) {
	return r.ApiService.ProbesGetExecute(r)
}
...
*/
func (a *ProbesAPIService) ProbesGet(ctx context.Context) ApiProbesGetRequest {
	return ApiProbesGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *ProbesAPIService) ProbesGetExecute(r ApiProbesGetRequest) (*Probes, *http.Response, error) {
	var (
		...
		formFiles            []formFile
		localVarReturnValue  *Probes
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ProbesAPIService.ProbesGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/probes"
