...
// checks if the Checks type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Checks{}
...
func NewNullableChecks(val *Checks) *NullableChecks {
	return &NullableChecks{value: val, isSet: true}
}
