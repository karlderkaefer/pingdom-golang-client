...
// checks if the DetailedHttpCustomAttributesType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DetailedHttpCustomAttributesType{}
...
func NewDetailedHttpCustomAttributesType() *DetailedHttpCustomAttributesType {
	this := DetailedHttpCustomAttributesType{}
	return &this
}
...
func (o *DetailedHttpCustomAttributesType) GetHttpcustom() HttpCustomAttributes {
	if o == nil || IsNil(o.Httpcustom) {
		var ret HttpCustomAttributes
		return ret
	}
	return *o.Httpcustom
}

// GetHttpcustomOk returns a tuple with the Httpcustom field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DetailedHttpCustomAttributesType) GetHttpcustomOk() (*HttpCustomAttributes, bool) {
	if o == nil || IsNil(o.Httpcustom) {
		return nil, false
	}
	return o.Httpcustom, true
}
...
func (o DetailedHttpCustomAttributesType) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.Httpcustom) {
		toSerialize["httpcustom"] = o.Httpcustom
	}
	return toSerialize, nil
}

type NullableDetailedHttpCustomAttributesType struct {
	value *DetailedHttpCustomAttributesType
	isSet bool
}

func (v NullableDetailedHttpCustomAttributesType) Get() *DetailedHttpCustomAttributesType {
	return v.value
}

func (v *NullableDetailedHttpCustomAttributesType) Set(val *DetailedHttpCustomAttributesType) {
	v.value = val
	v.isSet = true
}

func (v NullableDetailedHttpCustomAttributesType) IsSet() bool {
	return v.isSet
}

func (v *NullableDetailedHttpCustomAttributesType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDetailedHttpCustomAttributesType(val *DetailedHttpCustomAttributesType) *NullableDetailedHttpCustomAttributesType {
	return &NullableDetailedHttpCustomAttributesType{value: val, isSet: true}
}

func (v NullableDetailedHttpCustomAttributesType) MarshalJSON() ([]byte, error) {
