...
// checks if the DetailedCheckDns type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DetailedCheckDns{}
...
type NullableDetailedCheckDns struct {
	value *DetailedCheckDns
	isSet bool
}

func (v NullableDetailedCheckDns) Get() *DetailedCheckDns {
	return v.value
}

func (v *NullableDetailedCheckDns) Set(val *DetailedCheckDns) {
	v.value = val
	v.isSet = true
}
...
func NewNullableDetailedCheckDns(val *DetailedCheckDns) *NullableDetailedCheckDns {
	return &NullableDetailedCheckDns{value: val, isSet: true}
}
