...
func ArrayOfSummaryRespAttrsSummaryResponsetimeAvgresponseOneOfInnerAsSummaryRespAttrsSummaryResponsetimeAvgresponse(v *[]SummaryRespAttrsSummaryResponsetimeAvgresponseOneOfInner) SummaryRespAttrsSummaryResponsetimeAvgresponse {
	return SummaryRespAttrsSummaryResponsetimeAvgresponse{
		ArrayOfSummaryRespAttrsSummaryResponsetimeAvgresponseOneOfInner: v,
	}
}
...
func (dst *SummaryRespAttrsSummaryResponsetimeAvgresponse) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	// try to unmarshal data into ArrayOfSummaryRespAttrsSummaryResponsetimeAvgresponseOneOfInner
	err = newStrictDecoder(data).Decode(&dst.ArrayOfSummaryRespAttrsSummaryResponsetimeAvgresponseOneOfInner)
	if err == nil {
		jsonArrayOfSummaryRespAttrsSummaryResponsetimeAvgresponseOneOfInner, _ := json.Marshal(dst.ArrayOfSummaryRespAttrsSummaryResponsetimeAvgresponseOneOfInner)
		if string(jsonArrayOfSummaryRespAttrsSummaryResponsetimeAvgresponseOneOfInner) == "{}" { // empty struct
			dst.ArrayOfSummaryRespAttrsSummaryResponsetimeAvgresponseOneOfInner = nil
		} else {
			match++
		}
	} else {
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("data matches more than one schema in oneOf(SummaryRespAttrsSummaryResponsetimeAvgresponse)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("data failed to match schemas in oneOf(SummaryRespAttrsSummaryResponsetimeAvgresponse)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src SummaryRespAttrsSummaryResponsetimeAvgresponse) MarshalJSON() ([]byte, error) {
	if src.ArrayOfSummaryRespAttrsSummaryResponsetimeAvgresponseOneOfInner != nil {
		return json.Marshal(&src.ArrayOfSummaryRespAttrsSummaryResponsetimeAvgresponseOneOfInner)
	}
...
func (obj *SummaryRespAttrsSummaryResponsetimeAvgresponse) GetActualInstance() (interface{}) {
	...
	if obj.ArrayOfSummaryRespAttrsSummaryResponsetimeAvgresponseOneOfInner != nil {
		return obj.ArrayOfSummaryRespAttrsSummaryResponsetimeAvgresponseOneOfInner
	}
...
type NullableSummaryRespAttrsSummaryResponsetimeAvgresponse struct {
	value *SummaryRespAttrsSummaryResponsetimeAvgresponse
	isSet bool
}

func (v NullableSummaryRespAttrsSummaryResponsetimeAvgresponse) Get() *SummaryRespAttrsSummaryResponsetimeAvgresponse {
	return v.value
}

func (v *NullableSummaryRespAttrsSummaryResponsetimeAvgresponse) Set(val *SummaryRespAttrsSummaryResponsetimeAvgresponse) {
	v.value = val
	v.isSet = true
}

func (v NullableSummaryRespAttrsSummaryResponsetimeAvgresponse) IsSet() bool {
	return v.isSet
}

func (v *NullableSummaryRespAttrsSummaryResponsetimeAvgresponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSummaryRespAttrsSummaryResponsetimeAvgresponse(val *SummaryRespAttrsSummaryResponsetimeAvgresponse) *NullableSummaryRespAttrsSummaryResponsetimeAvgresponse {
	return &NullableSummaryRespAttrsSummaryResponsetimeAvgresponse{value: val, isSet: true}
}

func (v NullableSummaryRespAttrsSummaryResponsetimeAvgresponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSummaryRespAttrsSummaryResponsetimeAvgresponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
