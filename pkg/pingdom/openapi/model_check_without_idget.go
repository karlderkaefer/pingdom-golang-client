...
// checks if the CheckWithoutIDGET type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CheckWithoutIDGET{}
...
type NullableCheckWithoutIDGET struct {
	value *CheckWithoutIDGET
	isSet bool
}

func (v NullableCheckWithoutIDGET) Get() *CheckWithoutIDGET {
	return v.value
}

func (v *NullableCheckWithoutIDGET) Set(val *CheckWithoutIDGET) {
	v.value = val
	v.isSet = true
}
...
func NewNullableCheckWithoutIDGET(val *CheckWithoutIDGET) *NullableCheckWithoutIDGET {
	return &NullableCheckWithoutIDGET{value: val, isSet: true}
}
