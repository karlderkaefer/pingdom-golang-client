...
// checks if the DetailedDnsAttributes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DetailedDnsAttributes{}
...
type NullableDetailedDnsAttributes struct {
	value *DetailedDnsAttributes
	isSet bool
}

func (v NullableDetailedDnsAttributes) Get() *DetailedDnsAttributes {
	return v.value
}

func (v *NullableDetailedDnsAttributes) Set(val *DetailedDnsAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullableDetailedDnsAttributes) IsSet() bool {
	return v.isSet
}
...
func NewNullableDetailedDnsAttributes(val *DetailedDnsAttributes) *NullableDetailedDnsAttributes {
	return &NullableDetailedDnsAttributes{value: val, isSet: true}
}
