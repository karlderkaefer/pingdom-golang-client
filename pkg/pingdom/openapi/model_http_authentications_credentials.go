...
// checks if the HttpAuthenticationsCredentials type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HttpAuthenticationsCredentials{}
...
func NewHttpAuthenticationsCredentials() *HttpAuthenticationsCredentials {
	this := HttpAuthenticationsCredentials{}
	return &this
}
...
type NullableHttpAuthenticationsCredentials struct {
	value *HttpAuthenticationsCredentials
	isSet bool
}

func (v NullableHttpAuthenticationsCredentials) Get() *HttpAuthenticationsCredentials {
	return v.value
}

func (v *NullableHttpAuthenticationsCredentials) Set(val *HttpAuthenticationsCredentials) {
	v.value = val
	v.isSet = true
}

func (v NullableHttpAuthenticationsCredentials) IsSet() bool {
	return v.isSet
}

func (v *NullableHttpAuthenticationsCredentials) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHttpAuthenticationsCredentials(val *HttpAuthenticationsCredentials) *NullableHttpAuthenticationsCredentials {
	return &NullableHttpAuthenticationsCredentials{value: val, isSet: true}
}
