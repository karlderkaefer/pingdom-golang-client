...
// checks if the MetadataGET type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MetadataGET{}
...
func (o *MetadataGET) GetAuthentications() MetadataGETAuthentications {
	if o == nil || IsNil(o.Authentications) {
		var ret MetadataGETAuthentications
		return ret
	}
...
func (o MetadataGET) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.DisableWebSecurity) {
		toSerialize["disableWebSecurity"] = o.DisableWebSecurity
	}
...
func (v NullableMetadataGET) Get() *MetadataGET {
	return v.value
}
...
func NewNullableMetadataGET(val *MetadataGET) *NullableMetadataGET {
	return &NullableMetadataGET{value: val, isSet: true}
}
