...
func (v *SummaryOutageOrder) UnmarshalJSON(src []byte) error {
	...
	enumTypeValue := SummaryOutageOrder(value)
	for _, existing := range AllowedSummaryOutageOrderEnumValues {
	...
	return fmt.Errorf("%+v is not a valid SummaryOutageOrder", value)
}

// NewSummaryOutageOrderFromValue returns a pointer to a valid SummaryOutageOrder
// for the value passed as argument, or an error if the value passed is not allowed by the enum
func NewSummaryOutageOrderFromValue(v string) (*SummaryOutageOrder, error) {
	ev := SummaryOutageOrder(v)
	if ev.IsValid() {
		return &ev, nil
	} else {
		return nil, fmt.Errorf("invalid value '%v' for SummaryOutageOrder: valid values are %v", v, AllowedSummaryOutageOrderEnumValues)
	}
}
...
func (v SummaryOutageOrder) Ptr() *SummaryOutageOrder {
	return &v
}

type NullableSummaryOutageOrder struct {
	value *SummaryOutageOrder
	isSet bool
}

func (v NullableSummaryOutageOrder) Get() *SummaryOutageOrder {
	return v.value
}

func (v *NullableSummaryOutageOrder) Set(val *SummaryOutageOrder) {
	v.value = val
	v.isSet = true
}
...
func NewNullableSummaryOutageOrder(val *SummaryOutageOrder) *NullableSummaryOutageOrder {
	return &NullableSummaryOutageOrder{value: val, isSet: true}
}
