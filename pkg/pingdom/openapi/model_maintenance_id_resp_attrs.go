...
// checks if the MaintenanceIdRespAttrs type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MaintenanceIdRespAttrs{}
...
func (o *MaintenanceIdRespAttrs) GetMaintenance() MaintenanceIdRespAttrsMaintenance {
	if o == nil || IsNil(o.Maintenance) {
		var ret MaintenanceIdRespAttrsMaintenance
		return ret
	}
...
type NullableMaintenanceIdRespAttrs struct {
	value *MaintenanceIdRespAttrs
	isSet bool
}

func (v NullableMaintenanceIdRespAttrs) Get() *MaintenanceIdRespAttrs {
	return v.value
}

func (v *NullableMaintenanceIdRespAttrs) Set(val *MaintenanceIdRespAttrs) {
	v.value = val
	v.isSet = true
}

func (v NullableMaintenanceIdRespAttrs) IsSet() bool {
	return v.isSet
}
...
func NewNullableMaintenanceIdRespAttrs(val *MaintenanceIdRespAttrs) *NullableMaintenanceIdRespAttrs {
	return &NullableMaintenanceIdRespAttrs{value: val, isSet: true}
}
