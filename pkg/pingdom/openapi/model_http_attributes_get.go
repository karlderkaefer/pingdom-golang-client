...
// checks if the HttpAttributesGet type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HttpAttributesGet{}
...
type NullableHttpAttributesGet struct {
	value *HttpAttributesGet
	isSet bool
}

func (v NullableHttpAttributesGet) Get() *HttpAttributesGet {
	return v.value
}

func (v *NullableHttpAttributesGet) Set(val *HttpAttributesGet) {
	v.value = val
	v.isSet = true
}
...
func NewNullableHttpAttributesGet(val *HttpAttributesGet) *NullableHttpAttributesGet {
	return &NullableHttpAttributesGet{value: val, isSet: true}
}
