...
func (r ApiActionsGetRequest) From(from int32) ApiActionsGetRequest {
	r.from = &from
	return r
}

// Only include actions generated prior to this timestamp. Format is UNIX time.
func (r ApiActionsGetRequest) To(to int32) ApiActionsGetRequest {
	r.to = &to
	return r
}

// Limits the number of returned results to the specified quantity.
func (r ApiActionsGetRequest) Limit(limit int32) ApiActionsGetRequest {
	r.limit = &limit
	return r
}

// Offset for listing.
func (r ApiActionsGetRequest) Offset(offset int32) ApiActionsGetRequest {
	r.offset = &offset
	return r
}
...
func (r ApiActionsGetRequest) Userids(userids string) ApiActionsGetRequest {
	r.userids = &userids
	return r
}

// Comma-separated list of statuses. Limit results to actions with these statuses. Default: all statuses.
func (r ApiActionsGetRequest) Status(status string) ApiActionsGetRequest {
	r.status = &status
	return r
}

// Comma-separated list of via mediums. Limit results to actions with these mediums. Default: all mediums.
func (r ApiActionsGetRequest) Via(via string) ApiActionsGetRequest {
	r.via = &via
	return r
}

func (r ApiActionsGetRequest) Execute() (*ActionsAlertsEntry, *http.Response, error) {
...
func (a *ActionsAPIService) ActionsGetExecute(r ApiActionsGetRequest) (*ActionsAlertsEntry, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ActionsAlertsEntry
	)
	...
	if r.checkids != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "checkids", r.checkids, "")
	}
	if r.userids != nil {
