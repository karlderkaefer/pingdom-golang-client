...
// checks if the MaintenanceOccurrencesDeleteRespAttrs type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MaintenanceOccurrencesDeleteRespAttrs{}
...
func NewMaintenanceOccurrencesDeleteRespAttrs() *MaintenanceOccurrencesDeleteRespAttrs {
	this := MaintenanceOccurrencesDeleteRespAttrs{}
	return &this
}
...
type NullableMaintenanceOccurrencesDeleteRespAttrs struct {
	value *MaintenanceOccurrencesDeleteRespAttrs
	isSet bool
}

func (v NullableMaintenanceOccurrencesDeleteRespAttrs) Get() *MaintenanceOccurrencesDeleteRespAttrs {
	return v.value
}

func (v *NullableMaintenanceOccurrencesDeleteRespAttrs) Set(val *MaintenanceOccurrencesDeleteRespAttrs) {
	v.value = val
	v.isSet = true
}

func (v NullableMaintenanceOccurrencesDeleteRespAttrs) IsSet() bool {
	return v.isSet
}

func (v *NullableMaintenanceOccurrencesDeleteRespAttrs) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMaintenanceOccurrencesDeleteRespAttrs(val *MaintenanceOccurrencesDeleteRespAttrs) *NullableMaintenanceOccurrencesDeleteRespAttrs {
	return &NullableMaintenanceOccurrencesDeleteRespAttrs{value: val, isSet: true}
}

func (v NullableMaintenanceOccurrencesDeleteRespAttrs) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMaintenanceOccurrencesDeleteRespAttrs) UnmarshalJSON(src []byte) error {
	v.isSet = true
