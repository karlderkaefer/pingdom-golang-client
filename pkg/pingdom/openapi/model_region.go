...
func (o *Region) GetDatetimeformatid() int32 {
	if o == nil || IsNil(o.Datetimeformatid) {
		var ret int32
		return ret
	}
	return *o.Datetimeformatid
}

// GetDatetimeformatidOk returns a tuple with the Datetimeformatid field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Region) GetDatetimeformatidOk() (*int32, bool) {
	if o == nil || IsNil(o.Datetimeformatid) {
		return nil, false
	}
	return o.Datetimeformatid, true
}
...
func (o *Region) GetNumberformatid() int32 {
	if o == nil || IsNil(o.Numberformatid) {
		var ret int32
		return ret
	}
	return *o.Numberformatid
}

// GetNumberformatidOk returns a tuple with the Numberformatid field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Region) GetNumberformatidOk() (*int32, bool) {
	if o == nil || IsNil(o.Numberformatid) {
		return nil, false
	}
	return o.Numberformatid, true
}
...
func (o Region) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.Datetimeformatid) {
		toSerialize["datetimeformatid"] = o.Datetimeformatid
	}
	if !IsNil(o.Numberformatid) {
		toSerialize["numberformatid"] = o.Numberformatid
	}
