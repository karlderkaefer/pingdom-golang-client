...
// checks if the ChecksPutRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ChecksPutRequest{}
...
type NullableChecksPutRequest struct {
	value *ChecksPutRequest
	isSet bool
}

func (v NullableChecksPutRequest) Get() *ChecksPutRequest {
	return v.value
}

func (v *NullableChecksPutRequest) Set(val *ChecksPutRequest) {
	v.value = val
	v.isSet = true
}
...
func NewNullableChecksPutRequest(val *ChecksPutRequest) *NullableChecksPutRequest {
	return &NullableChecksPutRequest{value: val, isSet: true}
}
