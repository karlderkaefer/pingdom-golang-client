...
// checks if the DetailedCheckHttp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DetailedCheckHttp{}
...
func (o *DetailedCheckHttp) GetCheck() DetailedCheckHttpCheck {
	if o == nil || IsNil(o.Check) {
		var ret DetailedCheckHttpCheck
		return ret
	}
	return *o.Check
}
...
type NullableDetailedCheckHttp struct {
	value *DetailedCheckHttp
	isSet bool
}

func (v NullableDetailedCheckHttp) Get() *DetailedCheckHttp {
	return v.value
}

func (v *NullableDetailedCheckHttp) Set(val *DetailedCheckHttp) {
	v.value = val
	v.isSet = true
}
...
func NewNullableDetailedCheckHttp(val *DetailedCheckHttp) *NullableDetailedCheckHttp {
	return &NullableDetailedCheckHttp{value: val, isSet: true}
}
