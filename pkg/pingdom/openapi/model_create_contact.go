...
// checks if the CreateContact type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateContact{}
...
type _CreateContact CreateContact
...
func (o *CreateContact) GetNotificationTargets() CreateContactNotificationTargets {
	if o == nil {
		var ret CreateContactNotificationTargets
		return ret
	}
...
func (o *CreateContact) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateContact := _CreateContact{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateContact)

	if err != nil {
		return err
	}

	*o = CreateContact(varCreateContact)
...
func (v NullableCreateContact) Get() *CreateContact {
	return v.value
}
...
func NewNullableCreateContact(val *CreateContact) *NullableCreateContact {
	return &NullableCreateContact{value: val, isSet: true}
}
