...
// checks if the EmailsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EmailsInner{}
...
func (v NullableEmailsInner) Get() *EmailsInner {
	return v.value
}
...
func NewNullableEmailsInner(val *EmailsInner) *NullableEmailsInner {
	return &NullableEmailsInner{value: val, isSet: true}
}
