...
// checks if the MaintenanceIdPut type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MaintenanceIdPut{}
...
type NullableMaintenanceIdPut struct {
	value *MaintenanceIdPut
	isSet bool
}

func (v NullableMaintenanceIdPut) Get() *MaintenanceIdPut {
	return v.value
}

func (v *NullableMaintenanceIdPut) Set(val *MaintenanceIdPut) {
	v.value = val
	v.isSet = true
}
...
func NewNullableMaintenanceIdPut(val *MaintenanceIdPut) *NullableMaintenanceIdPut {
	return &NullableMaintenanceIdPut{value: val, isSet: true}
}
