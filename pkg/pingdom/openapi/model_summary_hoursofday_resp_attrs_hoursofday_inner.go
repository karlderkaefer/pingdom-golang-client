...
// checks if the SummaryHoursofdayRespAttrsHoursofdayInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SummaryHoursofdayRespAttrsHoursofdayInner{}
...
func NewSummaryHoursofdayRespAttrsHoursofdayInner() *SummaryHoursofdayRespAttrsHoursofdayInner {
	this := SummaryHoursofdayRespAttrsHoursofdayInner{}
	return &this
}
...
func (o SummaryHoursofdayRespAttrsHoursofdayInner) MarshalJSON() ([]byte, error) {
...
type NullableSummaryHoursofdayRespAttrsHoursofdayInner struct {
	value *SummaryHoursofdayRespAttrsHoursofdayInner
	isSet bool
}

func (v NullableSummaryHoursofdayRespAttrsHoursofdayInner) Get() *SummaryHoursofdayRespAttrsHoursofdayInner {
	return v.value
}

func (v *NullableSummaryHoursofdayRespAttrsHoursofdayInner) Set(val *SummaryHoursofdayRespAttrsHoursofdayInner) {
	v.value = val
	v.isSet = true
}

func (v NullableSummaryHoursofdayRespAttrsHoursofdayInner) IsSet() bool {
	return v.isSet
}

func (v *NullableSummaryHoursofdayRespAttrsHoursofdayInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSummaryHoursofdayRespAttrsHoursofdayInner(val *SummaryHoursofdayRespAttrsHoursofdayInner) *NullableSummaryHoursofdayRespAttrsHoursofdayInner {
	return &NullableSummaryHoursofdayRespAttrsHoursofdayInner{value: val, isSet: true}
}

func (v NullableSummaryHoursofdayRespAttrsHoursofdayInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSummaryHoursofdayRespAttrsHoursofdayInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
