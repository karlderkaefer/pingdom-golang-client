...
func (v *MaintenanceOrder) UnmarshalJSON(src []byte) error {
	...
	enumTypeValue := MaintenanceOrder(value)
	for _, existing := range AllowedMaintenanceOrderEnumValues {
	...
	return fmt.Errorf("%+v is not a valid MaintenanceOrder", value)
}

// NewMaintenanceOrderFromValue returns a pointer to a valid MaintenanceOrder
// for the value passed as argument, or an error if the value passed is not allowed by the enum
func NewMaintenanceOrderFromValue(v string) (*MaintenanceOrder, error) {
	ev := MaintenanceOrder(v)
	if ev.IsValid() {
		return &ev, nil
	} else {
		return nil, fmt.Errorf("invalid value '%v' for MaintenanceOrder: valid values are %v", v, AllowedMaintenanceOrderEnumValues)
	}
}
...
func (v MaintenanceOrder) Ptr() *MaintenanceOrder {
	return &v
}
...
func (v NullableMaintenanceOrder) Get() *MaintenanceOrder {
	return v.value
}

func (v *NullableMaintenanceOrder) Set(val *MaintenanceOrder) {
	v.value = val
	v.isSet = true
}
...
func NewNullableMaintenanceOrder(val *MaintenanceOrder) *NullableMaintenanceOrder {
	return &NullableMaintenanceOrder{value: val, isSet: true}
}
