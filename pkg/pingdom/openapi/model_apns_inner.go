...
// checks if the APNSInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &APNSInner{}
...
// GetApnsDeviceOk returns a tuple with the ApnsDevice field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *APNSInner) GetApnsDeviceOk() (*string, bool) {
	if o == nil || IsNil(o.ApnsDevice) {
		return nil, false
	}
	return o.ApnsDevice, true
}
...
func (o APNSInner) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ApnsDevice) {
		toSerialize["apns_device"] = o.ApnsDevice
	}
...
func NewNullableAPNSInner(val *APNSInner) *NullableAPNSInner {
	return &NullableAPNSInner{value: val, isSet: true}
}
