...
// checks if the HttpCertificateAttributes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HttpCertificateAttributes{}
...
func NewHttpCertificateAttributes() *HttpCertificateAttributes {
	this := HttpCertificateAttributes{}
...
type NullableHttpCertificateAttributes struct {
	value *HttpCertificateAttributes
	isSet bool
}

func (v NullableHttpCertificateAttributes) Get() *HttpCertificateAttributes {
	return v.value
}

func (v *NullableHttpCertificateAttributes) Set(val *HttpCertificateAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullableHttpCertificateAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullableHttpCertificateAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHttpCertificateAttributes(val *HttpCertificateAttributes) *NullableHttpCertificateAttributes {
	return &NullableHttpCertificateAttributes{value: val, isSet: true}
}
