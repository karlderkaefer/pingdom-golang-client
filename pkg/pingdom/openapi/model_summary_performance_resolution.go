...
func (v *SummaryPerformanceResolution) UnmarshalJSON(src []byte) error {
	...
	enumTypeValue := SummaryPerformanceResolution(value)
	for _, existing := range AllowedSummaryPerformanceResolutionEnumValues {
	...
	return fmt.Errorf("%+v is not a valid SummaryPerformanceResolution", value)
}

// NewSummaryPerformanceResolutionFromValue returns a pointer to a valid SummaryPerformanceResolution
// for the value passed as argument, or an error if the value passed is not allowed by the enum
func NewSummaryPerformanceResolutionFromValue(v string) (*SummaryPerformanceResolution, error) {
	ev := SummaryPerformanceResolution(v)
	if ev.IsValid() {
		return &ev, nil
	} else {
		return nil, fmt.Errorf("invalid value '%v' for SummaryPerformanceResolution: valid values are %v", v, AllowedSummaryPerformanceResolutionEnumValues)
	}
}
...
func (v SummaryPerformanceResolution) Ptr() *SummaryPerformanceResolution {
	return &v
}

type NullableSummaryPerformanceResolution struct {
	value *SummaryPerformanceResolution
	isSet bool
}

func (v NullableSummaryPerformanceResolution) Get() *SummaryPerformanceResolution {
	return v.value
}

func (v *NullableSummaryPerformanceResolution) Set(val *SummaryPerformanceResolution) {
	v.value = val
	v.isSet = true
}

func (v NullableSummaryPerformanceResolution) IsSet() bool {
	return v.isSet
}

func (v *NullableSummaryPerformanceResolution) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSummaryPerformanceResolution(val *SummaryPerformanceResolution) *NullableSummaryPerformanceResolution {
	return &NullableSummaryPerformanceResolution{value: val, isSet: true}
}
