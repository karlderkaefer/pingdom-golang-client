...
// checks if the DetailedCheckImap type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DetailedCheckImap{}
...
func (o *DetailedCheckImap) GetCheck() DetailedCheckImapCheck {
	if o == nil || IsNil(o.Check) {
		var ret DetailedCheckImapCheck
		return ret
	}
	return *o.Check
}
...
type NullableDetailedCheckImap struct {
	value *DetailedCheckImap
	isSet bool
}

func (v NullableDetailedCheckImap) Get() *DetailedCheckImap {
	return v.value
}

func (v *NullableDetailedCheckImap) Set(val *DetailedCheckImap) {
	v.value = val
	v.isSet = true
}
...
func NewNullableDetailedCheckImap(val *DetailedCheckImap) *NullableDetailedCheckImap {
	return &NullableDetailedCheckImap{value: val, isSet: true}
}
