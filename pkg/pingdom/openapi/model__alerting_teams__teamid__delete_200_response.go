...
// checks if the AlertingTeamsTeamidDelete200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AlertingTeamsTeamidDelete200Response{}
...
func NewAlertingTeamsTeamidDelete200Response() *AlertingTeamsTeamidDelete200Response {
	this := AlertingTeamsTeamidDelete200Response{}
	return &this
}
...
type NullableAlertingTeamsTeamidDelete200Response struct {
	value *AlertingTeamsTeamidDelete200Response
	isSet bool
}

func (v NullableAlertingTeamsTeamidDelete200Response) Get() *AlertingTeamsTeamidDelete200Response {
	return v.value
}

func (v *NullableAlertingTeamsTeamidDelete200Response) Set(val *AlertingTeamsTeamidDelete200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableAlertingTeamsTeamidDelete200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableAlertingTeamsTeamidDelete200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAlertingTeamsTeamidDelete200Response(val *AlertingTeamsTeamidDelete200Response) *NullableAlertingTeamsTeamidDelete200Response {
	return &NullableAlertingTeamsTeamidDelete200Response{value: val, isSet: true}
}

func (v NullableAlertingTeamsTeamidDelete200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAlertingTeamsTeamidDelete200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
