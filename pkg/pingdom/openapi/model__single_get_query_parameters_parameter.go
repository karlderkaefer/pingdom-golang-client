...
func DNSAsSingleGetQueryParametersParameter(v *DNS) SingleGetQueryParametersParameter {
	return SingleGetQueryParametersParameter{
		DNS: v,
	}
}
...
func (dst *SingleGetQueryParametersParameter) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	// try to unmarshal data into DNS
	err = newStrictDecoder(data).Decode(&dst.DNS)
	if err == nil {
		jsonDNS, _ := json.Marshal(dst.DNS)
		if string(jsonDNS) == "{}" { // empty struct
			dst.DNS = nil
		} else {
			match++
		}
	...
	// try to unmarshal data into HTTPCustom
	err = newStrictDecoder(data).Decode(&dst.HTTPCustom)
	if err == nil {
		jsonHTTPCustom, _ := json.Marshal(dst.HTTPCustom)
		if string(jsonHTTPCustom) == "{}" { // empty struct
			dst.HTTPCustom = nil
		} else {
			match++
		}
	...
	// try to unmarshal data into IMAP
	err = newStrictDecoder(data).Decode(&dst.IMAP)
	if err == nil {
		jsonIMAP, _ := json.Marshal(dst.IMAP)
		if string(jsonIMAP) == "{}" { // empty struct
			dst.IMAP = nil
		} else {
			match++
		}
	...
	// try to unmarshal data into POP3
	err = newStrictDecoder(data).Decode(&dst.POP3)
	if err == nil {
		jsonPOP3, _ := json.Marshal(dst.POP3)
		if string(jsonPOP3) == "{}" { // empty struct
			dst.POP3 = nil
		} else {
			match++
		}
	...
	// try to unmarshal data into SMTP
	err = newStrictDecoder(data).Decode(&dst.SMTP)
	if err == nil {
		jsonSMTP, _ := json.Marshal(dst.SMTP)
		if string(jsonSMTP) == "{}" { // empty struct
			dst.SMTP = nil
		} else {
			match++
		}
	...
	// try to unmarshal data into TCP
	err = newStrictDecoder(data).Decode(&dst.TCP)
	if err == nil {
		jsonTCP, _ := json.Marshal(dst.TCP)
		if string(jsonTCP) == "{}" { // empty struct
			dst.TCP = nil
		} else {
			match++
		}
	...
	// try to unmarshal data into UDP
	err = newStrictDecoder(data).Decode(&dst.UDP)
	if err == nil {
		jsonUDP, _ := json.Marshal(dst.UDP)
		if string(jsonUDP) == "{}" { // empty struct
			dst.UDP = nil
		} else {
			match++
		}
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("data matches more than one schema in oneOf(SingleGetQueryParametersParameter)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("data failed to match schemas in oneOf(SingleGetQueryParametersParameter)")
	}
}
...
func (src SingleGetQueryParametersParameter) MarshalJSON() ([]byte, error) {
	...
	if src.HTTPCustom != nil {
		return json.Marshal(&src.HTTPCustom)
	}

	if src.IMAP != nil {
		return json.Marshal(&src.IMAP)
	}

	if src.POP3 != nil {
		return json.Marshal(&src.POP3)
	}

	if src.SMTP != nil {
		return json.Marshal(&src.SMTP)
	}

	if src.TCP != nil {
		return json.Marshal(&src.TCP)
	}

	if src.UDP != nil {
		return json.Marshal(&src.UDP)
	}
...
func (obj *SingleGetQueryParametersParameter) GetActualInstance() (interface{}) {
	...
	if obj.HTTPCustom != nil {
		return obj.HTTPCustom
	}
...
type NullableSingleGetQueryParametersParameter struct {
	value *SingleGetQueryParametersParameter
	isSet bool
}

func (v NullableSingleGetQueryParametersParameter) Get() *SingleGetQueryParametersParameter {
	return v.value
}

func (v *NullableSingleGetQueryParametersParameter) Set(val *SingleGetQueryParametersParameter) {
	v.value = val
	v.isSet = true
}

func (v NullableSingleGetQueryParametersParameter) IsSet() bool {
	return v.isSet
}

func (v *NullableSingleGetQueryParametersParameter) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSingleGetQueryParametersParameter(val *SingleGetQueryParametersParameter) *NullableSingleGetQueryParametersParameter {
	return &NullableSingleGetQueryParametersParameter{value: val, isSet: true}
}

func (v NullableSingleGetQueryParametersParameter) MarshalJSON() ([]byte, error) {
