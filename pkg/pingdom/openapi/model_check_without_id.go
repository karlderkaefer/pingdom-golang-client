...
// checks if the CheckWithoutID type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CheckWithoutID{}
...
type _CheckWithoutID CheckWithoutID
...
func NewCheckWithoutID(name string, steps []Step) *CheckWithoutID {
	...
	this.Region = &region
	var sendNotificationWhenDown int64 = 1
	this.SendNotificationWhenDown = &sendNotificationWhenDown
	var severityLevel string = "high"
...
func (o *CheckWithoutID) UnmarshalJSON(data []byte) (err error) {
	...
	varCheckWithoutID := _CheckWithoutID{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCheckWithoutID)

	if err != nil {
		return err
	}

	*o = CheckWithoutID(varCheckWithoutID)

	return err
}

type NullableCheckWithoutID struct {
	value *CheckWithoutID
	isSet bool
}

func (v NullableCheckWithoutID) Get() *CheckWithoutID {
	return v.value
}

func (v *NullableCheckWithoutID) Set(val *CheckWithoutID) {
	v.value = val
	v.isSet = true
}
...
func NewNullableCheckWithoutID(val *CheckWithoutID) *NullableCheckWithoutID {
	return &NullableCheckWithoutID{value: val, isSet: true}
}
