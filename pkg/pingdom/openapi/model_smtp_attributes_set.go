...
// checks if the SmtpAttributesSet type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SmtpAttributesSet{}
...
type NullableSmtpAttributesSet struct {
	value *SmtpAttributesSet
	isSet bool
}

func (v NullableSmtpAttributesSet) Get() *SmtpAttributesSet {
	return v.value
}

func (v *NullableSmtpAttributesSet) Set(val *SmtpAttributesSet) {
	v.value = val
	v.isSet = true
}
...
func NewNullableSmtpAttributesSet(val *SmtpAttributesSet) *NullableSmtpAttributesSet {
	return &NullableSmtpAttributesSet{value: val, isSet: true}
}
