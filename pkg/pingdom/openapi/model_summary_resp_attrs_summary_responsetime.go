...
// checks if the SummaryRespAttrsSummaryResponsetime type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SummaryRespAttrsSummaryResponsetime{}
...
func NewSummaryRespAttrsSummaryResponsetime() *SummaryRespAttrsSummaryResponsetime {
	this := SummaryRespAttrsSummaryResponsetime{}
	return &this
}
...
func (o *SummaryRespAttrsSummaryResponsetime) GetAvgresponse() SummaryRespAttrsSummaryResponsetimeAvgresponse {
	if o == nil || IsNil(o.Avgresponse) {
		var ret SummaryRespAttrsSummaryResponsetimeAvgresponse
		return ret
	}
...
type NullableSummaryRespAttrsSummaryResponsetime struct {
	value *SummaryRespAttrsSummaryResponsetime
	isSet bool
}

func (v NullableSummaryRespAttrsSummaryResponsetime) Get() *SummaryRespAttrsSummaryResponsetime {
	return v.value
}

func (v *NullableSummaryRespAttrsSummaryResponsetime) Set(val *SummaryRespAttrsSummaryResponsetime) {
	v.value = val
	v.isSet = true
}

func (v NullableSummaryRespAttrsSummaryResponsetime) IsSet() bool {
	return v.isSet
}

func (v *NullableSummaryRespAttrsSummaryResponsetime) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSummaryRespAttrsSummaryResponsetime(val *SummaryRespAttrsSummaryResponsetime) *NullableSummaryRespAttrsSummaryResponsetime {
	return &NullableSummaryRespAttrsSummaryResponsetime{value: val, isSet: true}
}

func (v NullableSummaryRespAttrsSummaryResponsetime) MarshalJSON() ([]byte, error) {
