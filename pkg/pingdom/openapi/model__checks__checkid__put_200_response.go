...
// checks if the ChecksCheckidPut200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ChecksCheckidPut200Response{}
...
func NewChecksCheckidPut200Response() *ChecksCheckidPut200Response {
	this := ChecksCheckidPut200Response{}
	return &this
}
...
type NullableChecksCheckidPut200Response struct {
	value *ChecksCheckidPut200Response
	isSet bool
}

func (v NullableChecksCheckidPut200Response) Get() *ChecksCheckidPut200Response {
	return v.value
}

func (v *NullableChecksCheckidPut200Response) Set(val *ChecksCheckidPut200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableChecksCheckidPut200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableChecksCheckidPut200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableChecksCheckidPut200Response(val *ChecksCheckidPut200Response) *NullableChecksCheckidPut200Response {
	return &NullableChecksCheckidPut200Response{value: val, isSet: true}
}
