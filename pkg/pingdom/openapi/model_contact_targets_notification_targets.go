...
type NullableContactTargetsNotificationTargets struct {
	value *ContactTargetsNotificationTargets
	isSet bool
}

func (v NullableContactTargetsNotificationTargets) Get() *ContactTargetsNotificationTargets {
	return v.value
}

func (v *NullableContactTargetsNotificationTargets) Set(val *ContactTargetsNotificationTargets) {
	v.value = val
	v.isSet = true
}

func (v NullableContactTargetsNotificationTargets) IsSet() bool {
	return v.isSet
}

func (v *NullableContactTargetsNotificationTargets) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableContactTargetsNotificationTargets(val *ContactTargetsNotificationTargets) *NullableContactTargetsNotificationTargets {
	return &NullableContactTargetsNotificationTargets{value: val, isSet: true}
}

func (v NullableContactTargetsNotificationTargets) MarshalJSON() ([]byte, error) {
