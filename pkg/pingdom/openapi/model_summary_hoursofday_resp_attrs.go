...
// checks if the SummaryHoursofdayRespAttrs type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SummaryHoursofdayRespAttrs{}
...
func NewSummaryHoursofdayRespAttrs() *SummaryHoursofdayRespAttrs {
	this := SummaryHoursofdayRespAttrs{}
	return &this
}
...
func (o *SummaryHoursofdayRespAttrs) GetHoursofday() []SummaryHoursofdayRespAttrsHoursofdayInner {
	if o == nil || IsNil(o.Hoursofday) {
		var ret []SummaryHoursofdayRespAttrsHoursofdayInner
		return ret
	}
	return o.Hoursofday
}
...
func (o SummaryHoursofdayRespAttrs) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.Hoursofday) {
		toSerialize["hoursofday"] = o.Hoursofday
	}
	return toSerialize, nil
}

type NullableSummaryHoursofdayRespAttrs struct {
	value *SummaryHoursofdayRespAttrs
	isSet bool
}

func (v NullableSummaryHoursofdayRespAttrs) Get() *SummaryHoursofdayRespAttrs {
	return v.value
}

func (v *NullableSummaryHoursofdayRespAttrs) Set(val *SummaryHoursofdayRespAttrs) {
	v.value = val
	v.isSet = true
}

func (v NullableSummaryHoursofdayRespAttrs) IsSet() bool {
	return v.isSet
}

func (v *NullableSummaryHoursofdayRespAttrs) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSummaryHoursofdayRespAttrs(val *SummaryHoursofdayRespAttrs) *NullableSummaryHoursofdayRespAttrs {
	return &NullableSummaryHoursofdayRespAttrs{value: val, isSet: true}
}
