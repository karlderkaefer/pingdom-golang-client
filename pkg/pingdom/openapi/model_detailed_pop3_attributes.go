...
// checks if the DetailedPop3Attributes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DetailedPop3Attributes{}
...
type NullableDetailedPop3Attributes struct {
	value *DetailedPop3Attributes
	isSet bool
}

func (v NullableDetailedPop3Attributes) Get() *DetailedPop3Attributes {
	return v.value
}

func (v *NullableDetailedPop3Attributes) Set(val *DetailedPop3Attributes) {
	v.value = val
	v.isSet = true
}

func (v NullableDetailedPop3Attributes) IsSet() bool {
	return v.isSet
}
...
func NewNullableDetailedPop3Attributes(val *DetailedPop3Attributes) *NullableDetailedPop3Attributes {
	return &NullableDetailedPop3Attributes{value: val, isSet: true}
}
