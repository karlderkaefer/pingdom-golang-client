...
// checks if the AlertingTeamsPost200ResponseTeam type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AlertingTeamsPost200ResponseTeam{}
...
func NewAlertingTeamsPost200ResponseTeam() *AlertingTeamsPost200ResponseTeam {
	this := AlertingTeamsPost200ResponseTeam{}
	return &this
}
...
type NullableAlertingTeamsPost200ResponseTeam struct {
	value *AlertingTeamsPost200ResponseTeam
	isSet bool
}

func (v NullableAlertingTeamsPost200ResponseTeam) Get() *AlertingTeamsPost200ResponseTeam {
	return v.value
}

func (v *NullableAlertingTeamsPost200ResponseTeam) Set(val *AlertingTeamsPost200ResponseTeam) {
	v.value = val
	v.isSet = true
}

func (v NullableAlertingTeamsPost200ResponseTeam) IsSet() bool {
	return v.isSet
}

func (v *NullableAlertingTeamsPost200ResponseTeam) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAlertingTeamsPost200ResponseTeam(val *AlertingTeamsPost200ResponseTeam) *NullableAlertingTeamsPost200ResponseTeam {
	return &NullableAlertingTeamsPost200ResponseTeam{value: val, isSet: true}
}

func (v NullableAlertingTeamsPost200ResponseTeam) MarshalJSON() ([]byte, error) {
