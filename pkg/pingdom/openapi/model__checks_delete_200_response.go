...
// checks if the ChecksDelete200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ChecksDelete200Response{}
...
type NullableChecksDelete200Response struct {
	value *ChecksDelete200Response
	isSet bool
}

func (v NullableChecksDelete200Response) Get() *ChecksDelete200Response {
	return v.value
}

func (v *NullableChecksDelete200Response) Set(val *ChecksDelete200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableChecksDelete200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableChecksDelete200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableChecksDelete200Response(val *ChecksDelete200Response) *NullableChecksDelete200Response {
	return &NullableChecksDelete200Response{value: val, isSet: true}
}
