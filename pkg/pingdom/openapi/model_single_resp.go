...
// checks if the SingleResp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SingleResp{}
...
func NewNullableSingleResp(val *SingleResp) *NullableSingleResp {
	return &NullableSingleResp{value: val, isSet: true}
}
