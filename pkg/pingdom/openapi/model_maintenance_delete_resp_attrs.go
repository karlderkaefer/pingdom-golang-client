...
// checks if the MaintenanceDeleteRespAttrs type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MaintenanceDeleteRespAttrs{}
...
func NewMaintenanceDeleteRespAttrs() *MaintenanceDeleteRespAttrs {
	this := MaintenanceDeleteRespAttrs{}
	return &this
}
...
type NullableMaintenanceDeleteRespAttrs struct {
	value *MaintenanceDeleteRespAttrs
	isSet bool
}

func (v NullableMaintenanceDeleteRespAttrs) Get() *MaintenanceDeleteRespAttrs {
	return v.value
}

func (v *NullableMaintenanceDeleteRespAttrs) Set(val *MaintenanceDeleteRespAttrs) {
	v.value = val
	v.isSet = true
}

func (v NullableMaintenanceDeleteRespAttrs) IsSet() bool {
	return v.isSet
}

func (v *NullableMaintenanceDeleteRespAttrs) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMaintenanceDeleteRespAttrs(val *MaintenanceDeleteRespAttrs) *NullableMaintenanceDeleteRespAttrs {
	return &NullableMaintenanceDeleteRespAttrs{value: val, isSet: true}
}
