...
func (r ApiAlertingContactsContactidDeleteRequest) Execute() (*AlertingContactsContactidDelete200Response, *http.Response, error) {
	return r.ApiService.AlertingContactsContactidDeleteExecute(r)
}
...
func (a *ContactsAPIService) AlertingContactsContactidDeleteExecute(r ApiAlertingContactsContactidDeleteRequest) (*AlertingContactsContactidDelete200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodDelete
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *AlertingContactsContactidDelete200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ContactsAPIService.AlertingContactsContactidDelete")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/alerting/contacts/{contactid}"
...
func (r ApiAlertingContactsContactidGetRequest) Execute() (*Contact, *http.Response, error) {
	return r.ApiService.AlertingContactsContactidGetExecute(r)
}
...
func (a *ContactsAPIService) AlertingContactsContactidGetExecute(r ApiAlertingContactsContactidGetRequest) (*Contact, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ContactsAPIService.AlertingContactsContactidGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiAlertingContactsContactidPutRequest) UpdateContact(updateContact UpdateContact) ApiAlertingContactsContactidPutRequest {
	r.updateContact = &updateContact
	return r
}

func (r ApiAlertingContactsContactidPutRequest) Execute() (*Contact, *http.Response, error) {
	return r.ApiService.AlertingContactsContactidPutExecute(r)
}
...
func (a *ContactsAPIService) AlertingContactsContactidPutExecute(r ApiAlertingContactsContactidPutRequest) (*Contact, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ContactsAPIService.AlertingContactsContactidPut")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.updateContact == nil {
		return localVarReturnValue, nil, reportError("updateContact is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.updateContact
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
func (r ApiAlertingContactsGetRequest) Execute() (*ContactsList, *http.Response, error) {
	return r.ApiService.AlertingContactsGetExecute(r)
}
...
*/
func (a *ContactsAPIService) AlertingContactsGet(ctx context.Context) ApiAlertingContactsGetRequest {
	return ApiAlertingContactsGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *ContactsAPIService) AlertingContactsGetExecute(r ApiAlertingContactsGetRequest) (*ContactsList, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ContactsAPIService.AlertingContactsGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/alerting/contacts"
...
func (r ApiAlertingContactsPostRequest) CreateContact(createContact CreateContact) ApiAlertingContactsPostRequest {
	r.createContact = &createContact
	return r
}

func (r ApiAlertingContactsPostRequest) Execute() (*AlertingContactsPost200Response, *http.Response, error) {
	return r.ApiService.AlertingContactsPostExecute(r)
}
...
*/
func (a *ContactsAPIService) AlertingContactsPost(ctx context.Context) ApiAlertingContactsPostRequest {
	return ApiAlertingContactsPostRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *ContactsAPIService) AlertingContactsPostExecute(r ApiAlertingContactsPostRequest) (*AlertingContactsPost200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *AlertingContactsPost200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ContactsAPIService.AlertingContactsPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.createContact == nil {
		return localVarReturnValue, nil, reportError("createContact is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.createContact
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
