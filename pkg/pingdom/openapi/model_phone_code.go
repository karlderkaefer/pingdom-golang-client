...
// checks if the PhoneCode type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PhoneCode{}
...
func NewNullablePhoneCode(val *PhoneCode) *NullablePhoneCode {
	return &NullablePhoneCode{value: val, isSet: true}
}
