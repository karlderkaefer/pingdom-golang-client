...
// checks if the SummaryRespAttrsSummaryResponsetimeAvgresponseOneOfInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SummaryRespAttrsSummaryResponsetimeAvgresponseOneOfInner{}
...
func NewSummaryRespAttrsSummaryResponsetimeAvgresponseOneOfInner() *SummaryRespAttrsSummaryResponsetimeAvgresponseOneOfInner {
	this := SummaryRespAttrsSummaryResponsetimeAvgresponseOneOfInner{}
	return &this
}
...
func (o SummaryRespAttrsSummaryResponsetimeAvgresponseOneOfInner) MarshalJSON() ([]byte, error) {
...
func (o SummaryRespAttrsSummaryResponsetimeAvgresponseOneOfInner) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.Avgresponse) {
		toSerialize["avgresponse"] = o.Avgresponse
	}
	return toSerialize, nil
}

type NullableSummaryRespAttrsSummaryResponsetimeAvgresponseOneOfInner struct {
	value *SummaryRespAttrsSummaryResponsetimeAvgresponseOneOfInner
	isSet bool
}

func (v NullableSummaryRespAttrsSummaryResponsetimeAvgresponseOneOfInner) Get() *SummaryRespAttrsSummaryResponsetimeAvgresponseOneOfInner {
	return v.value
}

func (v *NullableSummaryRespAttrsSummaryResponsetimeAvgresponseOneOfInner) Set(val *SummaryRespAttrsSummaryResponsetimeAvgresponseOneOfInner) {
	v.value = val
	v.isSet = true
}

func (v NullableSummaryRespAttrsSummaryResponsetimeAvgresponseOneOfInner) IsSet() bool {
	return v.isSet
}

func (v *NullableSummaryRespAttrsSummaryResponsetimeAvgresponseOneOfInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSummaryRespAttrsSummaryResponsetimeAvgresponseOneOfInner(val *SummaryRespAttrsSummaryResponsetimeAvgresponseOneOfInner) *NullableSummaryRespAttrsSummaryResponsetimeAvgresponseOneOfInner {
	return &NullableSummaryRespAttrsSummaryResponsetimeAvgresponseOneOfInner{value: val, isSet: true}
}

func (v NullableSummaryRespAttrsSummaryResponsetimeAvgresponseOneOfInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSummaryRespAttrsSummaryResponsetimeAvgresponseOneOfInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
