...
// checks if the MaintenanceRespAttrsMaintenanceInnerChecks type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MaintenanceRespAttrsMaintenanceInnerChecks{}
...
func NewMaintenanceRespAttrsMaintenanceInnerChecks() *MaintenanceRespAttrsMaintenanceInnerChecks {
	this := MaintenanceRespAttrsMaintenanceInnerChecks{}
	return &this
}
...
// GetTmsOk returns a tuple with the Tms field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
func (o MaintenanceRespAttrsMaintenanceInnerChecks) MarshalJSON() ([]byte, error) {
...
func (o MaintenanceRespAttrsMaintenanceInnerChecks) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.Tms) {
		toSerialize["tms"] = o.Tms
	}
	return toSerialize, nil
}

type NullableMaintenanceRespAttrsMaintenanceInnerChecks struct {
	value *MaintenanceRespAttrsMaintenanceInnerChecks
	isSet bool
}

func (v NullableMaintenanceRespAttrsMaintenanceInnerChecks) Get() *MaintenanceRespAttrsMaintenanceInnerChecks {
	return v.value
}

func (v *NullableMaintenanceRespAttrsMaintenanceInnerChecks) Set(val *MaintenanceRespAttrsMaintenanceInnerChecks) {
	v.value = val
	v.isSet = true
}

func (v NullableMaintenanceRespAttrsMaintenanceInnerChecks) IsSet() bool {
	return v.isSet
}

func (v *NullableMaintenanceRespAttrsMaintenanceInnerChecks) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMaintenanceRespAttrsMaintenanceInnerChecks(val *MaintenanceRespAttrsMaintenanceInnerChecks) *NullableMaintenanceRespAttrsMaintenanceInnerChecks {
	return &NullableMaintenanceRespAttrsMaintenanceInnerChecks{value: val, isSet: true}
}

func (v NullableMaintenanceRespAttrsMaintenanceInnerChecks) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMaintenanceRespAttrsMaintenanceInnerChecks) UnmarshalJSON(src []byte) error {
	v.isSet = true
