...
// checks if the ResultsRespAttrsResultsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResultsRespAttrsResultsInner{}
...
func NewResultsRespAttrsResultsInner() *ResultsRespAttrsResultsInner {
	this := ResultsRespAttrsResultsInner{}
	return &this
}
...
func (o *ResultsRespAttrsResultsInner) GetStatusdesclong() string {
	if o == nil || IsNil(o.Statusdesclong) {
		var ret string
		return ret
	}
	return *o.Statusdesclong
}

// GetStatusdesclongOk returns a tuple with the Statusdesclong field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ResultsRespAttrsResultsInner) GetStatusdesclongOk() (*string, bool) {
	if o == nil || IsNil(o.Statusdesclong) {
		return nil, false
	}
	return o.Statusdesclong, true
}
...
func (o ResultsRespAttrsResultsInner) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.Statusdesc) {
		toSerialize["statusdesc"] = o.Statusdesc
	}
	if !IsNil(o.Statusdesclong) {
		toSerialize["statusdesclong"] = o.Statusdesclong
	}
	return toSerialize, nil
}

type NullableResultsRespAttrsResultsInner struct {
	value *ResultsRespAttrsResultsInner
	isSet bool
}

func (v NullableResultsRespAttrsResultsInner) Get() *ResultsRespAttrsResultsInner {
	return v.value
}

func (v *NullableResultsRespAttrsResultsInner) Set(val *ResultsRespAttrsResultsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableResultsRespAttrsResultsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableResultsRespAttrsResultsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResultsRespAttrsResultsInner(val *ResultsRespAttrsResultsInner) *NullableResultsRespAttrsResultsInner {
	return &NullableResultsRespAttrsResultsInner{value: val, isSet: true}
}
