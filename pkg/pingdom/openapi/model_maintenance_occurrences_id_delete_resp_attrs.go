...
// checks if the MaintenanceOccurrencesIdDeleteRespAttrs type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MaintenanceOccurrencesIdDeleteRespAttrs{}
...
func NewMaintenanceOccurrencesIdDeleteRespAttrs() *MaintenanceOccurrencesIdDeleteRespAttrs {
	this := MaintenanceOccurrencesIdDeleteRespAttrs{}
	return &this
}
...
type NullableMaintenanceOccurrencesIdDeleteRespAttrs struct {
	value *MaintenanceOccurrencesIdDeleteRespAttrs
	isSet bool
}

func (v NullableMaintenanceOccurrencesIdDeleteRespAttrs) Get() *MaintenanceOccurrencesIdDeleteRespAttrs {
	return v.value
}

func (v *NullableMaintenanceOccurrencesIdDeleteRespAttrs) Set(val *MaintenanceOccurrencesIdDeleteRespAttrs) {
	v.value = val
	v.isSet = true
}

func (v NullableMaintenanceOccurrencesIdDeleteRespAttrs) IsSet() bool {
	return v.isSet
}

func (v *NullableMaintenanceOccurrencesIdDeleteRespAttrs) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMaintenanceOccurrencesIdDeleteRespAttrs(val *MaintenanceOccurrencesIdDeleteRespAttrs) *NullableMaintenanceOccurrencesIdDeleteRespAttrs {
	return &NullableMaintenanceOccurrencesIdDeleteRespAttrs{value: val, isSet: true}
}

func (v NullableMaintenanceOccurrencesIdDeleteRespAttrs) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMaintenanceOccurrencesIdDeleteRespAttrs) UnmarshalJSON(src []byte) error {
	v.isSet = true
