...
func (dst *ModifyCheckSettings) UnmarshalJSON(data []byte) error {
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("data matches more than one schema in oneOf(ModifyCheckSettings)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("data failed to match schemas in oneOf(ModifyCheckSettings)")
	}
}
...
type NullableModifyCheckSettings struct {
	value *ModifyCheckSettings
	isSet bool
}

func (v NullableModifyCheckSettings) Get() *ModifyCheckSettings {
	return v.value
}

func (v *NullableModifyCheckSettings) Set(val *ModifyCheckSettings) {
	v.value = val
	v.isSet = true
}

func (v NullableModifyCheckSettings) IsSet() bool {
	return v.isSet
}
...
func NewNullableModifyCheckSettings(val *ModifyCheckSettings) *NullableModifyCheckSettings {
	return &NullableModifyCheckSettings{value: val, isSet: true}
}
