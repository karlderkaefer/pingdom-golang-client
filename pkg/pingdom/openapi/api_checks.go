...
func (r ApiChecksCheckidDeleteRequest) Execute() (*ChecksCheckidDelete200Response, *http.Response, error) {
	return r.ApiService.ChecksCheckidDeleteExecute(r)
}
...
func (a *ChecksAPIService) ChecksCheckidDeleteExecute(r ApiChecksCheckidDeleteRequest) (*ChecksCheckidDelete200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodDelete
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ChecksCheckidDelete200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ChecksAPIService.ChecksCheckidDelete")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/checks/{checkid}"
...
func (r ApiChecksCheckidGetRequest) Execute() (*DetailedCheck, *http.Response, error) {
	return r.ApiService.ChecksCheckidGetExecute(r)
}
...
func (a *ChecksAPIService) ChecksCheckidGetExecute(r ApiChecksCheckidGetRequest) (*DetailedCheck, *http.Response, error) {
	var (
		...
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *DetailedCheck
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ChecksAPIService.ChecksCheckidGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	if r.includeTeams != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "include_teams", r.includeTeams, "")
	} else {
		var defaultValue bool = false
		r.includeTeams = &defaultValue
	}
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
...
type ApiChecksCheckidPutRequest struct {
	...
	ApiService *ChecksAPIService
	checkid int32
	modifyCheckSettings *ModifyCheckSettings
}

func (r ApiChecksCheckidPutRequest) ModifyCheckSettings(modifyCheckSettings ModifyCheckSettings) ApiChecksCheckidPutRequest {
	r.modifyCheckSettings = &modifyCheckSettings
	return r
}

func (r ApiChecksCheckidPutRequest) Execute() (*ChecksCheckidPut200Response, *http.Response, error) {
	return r.ApiService.ChecksCheckidPutExecute(r)
}
...
func (a *ChecksAPIService) ChecksCheckidPutExecute(r ApiChecksCheckidPutRequest) (*ChecksCheckidPut200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ChecksCheckidPut200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ChecksAPIService.ChecksCheckidPut")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.modifyCheckSettings == nil {
		return localVarReturnValue, nil, reportError("modifyCheckSettings is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.modifyCheckSettings
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
func (r ApiChecksDeleteRequest) Delcheckids(delcheckids []int32) ApiChecksDeleteRequest {
	r.delcheckids = &delcheckids
	return r
}

func (r ApiChecksDeleteRequest) Body(body string) ApiChecksDeleteRequest {
	r.body = &body
	return r
}

func (r ApiChecksDeleteRequest) Execute() (*ChecksDelete200Response, *http.Response, error) {
	return r.ApiService.ChecksDeleteExecute(r)
}
...
*/
func (a *ChecksAPIService) ChecksDelete(ctx context.Context) ApiChecksDeleteRequest {
	return ApiChecksDeleteRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *ChecksAPIService) ChecksDeleteExecute(r ApiChecksDeleteRequest) (*ChecksDelete200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodDelete
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ChecksDelete200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ChecksAPIService.ChecksDelete")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.delcheckids == nil {
		return localVarReturnValue, nil, reportError("delcheckids is required and must be specified")
	}
	if r.body == nil {
		return localVarReturnValue, nil, reportError("body is required and must be specified")
	}

	parameterAddToHeaderOrQuery(localVarQueryParams, "delcheckids", r.delcheckids, "csv")
	// to determine the Content-Type header
...
func (r ApiChecksGetRequest) Limit(limit int32) ApiChecksGetRequest {
	r.limit = &limit
	return r
}

// Offset for listing. (Requires limit.)
func (r ApiChecksGetRequest) Offset(offset int32) ApiChecksGetRequest {
	r.offset = &offset
	return r
}
...
func (r ApiChecksGetRequest) Showencryption(showencryption bool) ApiChecksGetRequest {
	r.showencryption = &showencryption
	return r
}
...
func (r ApiChecksGetRequest) IncludeSeverity(includeSeverity bool) ApiChecksGetRequest {
	r.includeSeverity = &includeSeverity
	return r
}
...
func (r ApiChecksGetRequest) Tags(tags string) ApiChecksGetRequest {
	r.tags = &tags
	return r
}
...
*/
func (a *ChecksAPIService) ChecksGet(ctx context.Context) ApiChecksGetRequest {
	return ApiChecksGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *ChecksAPIService) ChecksGetExecute(r ApiChecksGetRequest) (*Checks, *http.Response, error) {
	...
	if r.showencryption != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "showencryption", r.showencryption, "")
	} else {
		var defaultValue bool = false
		r.showencryption = &defaultValue
	}
	...
	if r.includeSeverity != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "include_severity", r.includeSeverity, "")
	} else {
		var defaultValue bool = false
		r.includeSeverity = &defaultValue
	}
	if r.tags != nil {
...
func (r ApiChecksPostRequest) CreateCheck(createCheck CreateCheck) ApiChecksPostRequest {
	r.createCheck = &createCheck
	return r
}

func (r ApiChecksPostRequest) Execute() (*ChecksPost200Response, *http.Response, error) {
	return r.ApiService.ChecksPostExecute(r)
}
...
*/
func (a *ChecksAPIService) ChecksPost(ctx context.Context) ApiChecksPostRequest {
	return ApiChecksPostRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *ChecksAPIService) ChecksPostExecute(r ApiChecksPostRequest) (*ChecksPost200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ChecksPost200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ChecksAPIService.ChecksPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.createCheck == nil {
		return localVarReturnValue, nil, reportError("createCheck is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.createCheck
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
type ApiChecksPutRequest struct {
	ctx context.Context
	ApiService *ChecksAPIService
	checksPutRequest *ChecksPutRequest
}

func (r ApiChecksPutRequest) ChecksPutRequest(checksPutRequest ChecksPutRequest) ApiChecksPutRequest {
	r.checksPutRequest = &checksPutRequest
	return r
}

func (r ApiChecksPutRequest) Execute() (*ChecksPut200Response, *http.Response, error) {
	return r.ApiService.ChecksPutExecute(r)
}
...
*/
func (a *ChecksAPIService) ChecksPut(ctx context.Context) ApiChecksPutRequest {
	return ApiChecksPutRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *ChecksAPIService) ChecksPutExecute(r ApiChecksPutRequest) (*ChecksPut200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ChecksPut200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ChecksAPIService.ChecksPut")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.checksPutRequest == nil {
		return localVarReturnValue, nil, reportError("checksPutRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.checksPutRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
