...
// checks if the DetailedSmtpAttributes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DetailedSmtpAttributes{}
...
type NullableDetailedSmtpAttributes struct {
	value *DetailedSmtpAttributes
	isSet bool
}

func (v NullableDetailedSmtpAttributes) Get() *DetailedSmtpAttributes {
	return v.value
}

func (v *NullableDetailedSmtpAttributes) Set(val *DetailedSmtpAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullableDetailedSmtpAttributes) IsSet() bool {
	return v.isSet
}
...
func NewNullableDetailedSmtpAttributes(val *DetailedSmtpAttributes) *NullableDetailedSmtpAttributes {
	return &NullableDetailedSmtpAttributes{value: val, isSet: true}
}
