...
// checks if the SummaryPerformanceResultsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SummaryPerformanceResultsInner{}
...
func NewSummaryPerformanceResultsInner() *SummaryPerformanceResultsInner {
	this := SummaryPerformanceResultsInner{}
	return &this
}
...
type NullableSummaryPerformanceResultsInner struct {
	value *SummaryPerformanceResultsInner
	isSet bool
}

func (v NullableSummaryPerformanceResultsInner) Get() *SummaryPerformanceResultsInner {
	return v.value
}

func (v *NullableSummaryPerformanceResultsInner) Set(val *SummaryPerformanceResultsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableSummaryPerformanceResultsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableSummaryPerformanceResultsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSummaryPerformanceResultsInner(val *SummaryPerformanceResultsInner) *NullableSummaryPerformanceResultsInner {
	return &NullableSummaryPerformanceResultsInner{value: val, isSet: true}
}
