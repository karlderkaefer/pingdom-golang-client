...
// checks if the DetailedHttpAttributesType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DetailedHttpAttributesType{}
...
func NewDetailedHttpAttributesType() *DetailedHttpAttributesType {
	this := DetailedHttpAttributesType{}
	return &this
}
...
type NullableDetailedHttpAttributesType struct {
	value *DetailedHttpAttributesType
	isSet bool
}

func (v NullableDetailedHttpAttributesType) Get() *DetailedHttpAttributesType {
	return v.value
}

func (v *NullableDetailedHttpAttributesType) Set(val *DetailedHttpAttributesType) {
	v.value = val
	v.isSet = true
}

func (v NullableDetailedHttpAttributesType) IsSet() bool {
	return v.isSet
}

func (v *NullableDetailedHttpAttributesType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDetailedHttpAttributesType(val *DetailedHttpAttributesType) *NullableDetailedHttpAttributesType {
	return &NullableDetailedHttpAttributesType{value: val, isSet: true}
}
