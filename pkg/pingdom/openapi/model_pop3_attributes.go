...
// checks if the Pop3Attributes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Pop3Attributes{}
...
type NullablePop3Attributes struct {
	value *Pop3Attributes
	isSet bool
}

func (v NullablePop3Attributes) Get() *Pop3Attributes {
	return v.value
}

func (v *NullablePop3Attributes) Set(val *Pop3Attributes) {
	v.value = val
	v.isSet = true
}
...
func NewNullablePop3Attributes(val *Pop3Attributes) *NullablePop3Attributes {
	return &NullablePop3Attributes{value: val, isSet: true}
}
