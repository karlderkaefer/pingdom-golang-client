...
// checks if the MaintenanceOccurrencesRespAttrs type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MaintenanceOccurrencesRespAttrs{}
...
func NewMaintenanceOccurrencesRespAttrs() *MaintenanceOccurrencesRespAttrs {
	this := MaintenanceOccurrencesRespAttrs{}
	return &this
}
...
func (o *MaintenanceOccurrencesRespAttrs) GetOccurrences() []MaintenanceOccurrencesRespAttrsOccurrencesInner {
	if o == nil || IsNil(o.Occurrences) {
		var ret []MaintenanceOccurrencesRespAttrsOccurrencesInner
		return ret
	}
...
type NullableMaintenanceOccurrencesRespAttrs struct {
	value *MaintenanceOccurrencesRespAttrs
	isSet bool
}

func (v NullableMaintenanceOccurrencesRespAttrs) Get() *MaintenanceOccurrencesRespAttrs {
	return v.value
}

func (v *NullableMaintenanceOccurrencesRespAttrs) Set(val *MaintenanceOccurrencesRespAttrs) {
	v.value = val
	v.isSet = true
}

func (v NullableMaintenanceOccurrencesRespAttrs) IsSet() bool {
	return v.isSet
}

func (v *NullableMaintenanceOccurrencesRespAttrs) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMaintenanceOccurrencesRespAttrs(val *MaintenanceOccurrencesRespAttrs) *NullableMaintenanceOccurrencesRespAttrs {
	return &NullableMaintenanceOccurrencesRespAttrs{value: val, isSet: true}
}
