...
// checks if the ReportPerformance type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReportPerformance{}
...
func (o *ReportPerformance) GetReport() ReportPerformanceReport {
	if o == nil || IsNil(o.Report) {
		var ret ReportPerformanceReport
		return ret
	}
	return *o.Report
}
...
func (v NullableReportPerformance) Get() *ReportPerformance {
	return v.value
}

func (v *NullableReportPerformance) Set(val *ReportPerformance) {
	v.value = val
	v.isSet = true
}
...
func NewNullableReportPerformance(val *ReportPerformance) *NullableReportPerformance {
	return &NullableReportPerformance{value: val, isSet: true}
}
