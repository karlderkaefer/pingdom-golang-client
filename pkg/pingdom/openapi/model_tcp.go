...
// checks if the TCP type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TCP{}
...
func NewNullableTCP(val *TCP) *NullableTCP {
	return &NullableTCP{value: val, isSet: true}
}
