...
func (v *SummaryPerformanceOrder) UnmarshalJSON(src []byte) error {
	...
	enumTypeValue := SummaryPerformanceOrder(value)
	for _, existing := range AllowedSummaryPerformanceOrderEnumValues {
	...
	return fmt.Errorf("%+v is not a valid SummaryPerformanceOrder", value)
}

// NewSummaryPerformanceOrderFromValue returns a pointer to a valid SummaryPerformanceOrder
// for the value passed as argument, or an error if the value passed is not allowed by the enum
func NewSummaryPerformanceOrderFromValue(v string) (*SummaryPerformanceOrder, error) {
	ev := SummaryPerformanceOrder(v)
	if ev.IsValid() {
		return &ev, nil
	} else {
		return nil, fmt.Errorf("invalid value '%v' for SummaryPerformanceOrder: valid values are %v", v, AllowedSummaryPerformanceOrderEnumValues)
	}
}
...
func (v SummaryPerformanceOrder) Ptr() *SummaryPerformanceOrder {
	return &v
}

type NullableSummaryPerformanceOrder struct {
	value *SummaryPerformanceOrder
	isSet bool
}

func (v NullableSummaryPerformanceOrder) Get() *SummaryPerformanceOrder {
	return v.value
}

func (v *NullableSummaryPerformanceOrder) Set(val *SummaryPerformanceOrder) {
	v.value = val
	v.isSet = true
}

func (v NullableSummaryPerformanceOrder) IsSet() bool {
	return v.isSet
}

func (v *NullableSummaryPerformanceOrder) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSummaryPerformanceOrder(val *SummaryPerformanceOrder) *NullableSummaryPerformanceOrder {
	return &NullableSummaryPerformanceOrder{value: val, isSet: true}
}
