...
func (r ApiAlertingTeamsGetRequest) Execute() (*Teams, *http.Response, error) {
	return r.ApiService.AlertingTeamsGetExecute(r)
}
...
func (a *TeamsAPIService) AlertingTeamsGetExecute(r ApiAlertingTeamsGetRequest) (*Teams, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TeamsAPIService.AlertingTeamsGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/alerting/teams"
...
func (r ApiAlertingTeamsPostRequest) CreateTeam(createTeam CreateTeam) ApiAlertingTeamsPostRequest {
	r.createTeam = &createTeam
	return r
}

func (r ApiAlertingTeamsPostRequest) Execute() (*AlertingTeamsPost200Response, *http.Response, error) {
	return r.ApiService.AlertingTeamsPostExecute(r)
}
...
func (a *TeamsAPIService) AlertingTeamsPostExecute(r ApiAlertingTeamsPostRequest) (*AlertingTeamsPost200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *AlertingTeamsPost200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TeamsAPIService.AlertingTeamsPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiAlertingTeamsTeamidDeleteRequest) Execute() (*AlertingTeamsTeamidDelete200Response, *http.Response, error) {
	return r.ApiService.AlertingTeamsTeamidDeleteExecute(r)
}
...
func (a *TeamsAPIService) AlertingTeamsTeamidDeleteExecute(r ApiAlertingTeamsTeamidDeleteRequest) (*AlertingTeamsTeamidDelete200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodDelete
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *AlertingTeamsTeamidDelete200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TeamsAPIService.AlertingTeamsTeamidDelete")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/alerting/teams/{teamid}"
...
func (r ApiAlertingTeamsTeamidGetRequest) Execute() (*TeamID, *http.Response, error) {
	return r.ApiService.AlertingTeamsTeamidGetExecute(r)
}
...
func (a *TeamsAPIService) AlertingTeamsTeamidGetExecute(r ApiAlertingTeamsTeamidGetRequest) (*TeamID, *http.Response, error) {
	var (
		...
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *TeamID
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TeamsAPIService.AlertingTeamsTeamidGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiAlertingTeamsTeamidPutRequest) UpdateTeam(updateTeam UpdateTeam) ApiAlertingTeamsTeamidPutRequest {
	r.updateTeam = &updateTeam
	return r
}

func (r ApiAlertingTeamsTeamidPutRequest) Execute() (*TeamID, *http.Response, error) {
	return r.ApiService.AlertingTeamsTeamidPutExecute(r)
}
...
func (a *TeamsAPIService) AlertingTeamsTeamidPutExecute(r ApiAlertingTeamsTeamidPutRequest) (*TeamID, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TeamsAPIService.AlertingTeamsTeamidPut")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	localVarFormParams := url.Values{}
	if r.updateTeam == nil {
		return localVarReturnValue, nil, reportError("updateTeam is required and must be specified")
	}
