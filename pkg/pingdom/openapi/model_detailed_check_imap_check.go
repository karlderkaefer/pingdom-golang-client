...
// checks if the DetailedCheckImapCheck type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DetailedCheckImapCheck{}
...
func (o *DetailedCheckImapCheck) GetType() DetailedImapAttributesType {
	if o == nil || IsNil(o.Type) {
		var ret DetailedImapAttributesType
		return ret
	}
	return *o.Type
}
...
type NullableDetailedCheckImapCheck struct {
	value *DetailedCheckImapCheck
	isSet bool
}

func (v NullableDetailedCheckImapCheck) Get() *DetailedCheckImapCheck {
	return v.value
}

func (v *NullableDetailedCheckImapCheck) Set(val *DetailedCheckImapCheck) {
	v.value = val
	v.isSet = true
}

func (v NullableDetailedCheckImapCheck) IsSet() bool {
	return v.isSet
}
...
func NewNullableDetailedCheckImapCheck(val *DetailedCheckImapCheck) *NullableDetailedCheckImapCheck {
	return &NullableDetailedCheckImapCheck{value: val, isSet: true}
}
