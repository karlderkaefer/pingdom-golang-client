...
// checks if the AnalysisRespAttrs type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AnalysisRespAttrs{}
...
func (o *AnalysisRespAttrs) GetAnalysis() []AnalysisRespAttrsAnalysisInner {
	if o == nil || IsNil(o.Analysis) {
		var ret []AnalysisRespAttrsAnalysisInner
		return ret
	}
	return o.Analysis
}
...
type NullableAnalysisRespAttrs struct {
	value *AnalysisRespAttrs
	isSet bool
}

func (v NullableAnalysisRespAttrs) Get() *AnalysisRespAttrs {
	return v.value
}

func (v *NullableAnalysisRespAttrs) Set(val *AnalysisRespAttrs) {
	v.value = val
	v.isSet = true
}
...
func NewNullableAnalysisRespAttrs(val *AnalysisRespAttrs) *NullableAnalysisRespAttrs {
	return &NullableAnalysisRespAttrs{value: val, isSet: true}
}
