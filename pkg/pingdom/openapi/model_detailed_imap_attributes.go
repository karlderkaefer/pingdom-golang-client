...
// checks if the DetailedImapAttributes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DetailedImapAttributes{}
...
type NullableDetailedImapAttributes struct {
	value *DetailedImapAttributes
	isSet bool
}

func (v NullableDetailedImapAttributes) Get() *DetailedImapAttributes {
	return v.value
}

func (v *NullableDetailedImapAttributes) Set(val *DetailedImapAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullableDetailedImapAttributes) IsSet() bool {
	return v.isSet
}
...
func NewNullableDetailedImapAttributes(val *DetailedImapAttributes) *NullableDetailedImapAttributes {
	return &NullableDetailedImapAttributes{value: val, isSet: true}
}
