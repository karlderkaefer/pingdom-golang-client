...
// checks if the MaintenanceOccurrencesIdRespAttrsOccurrence type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MaintenanceOccurrencesIdRespAttrsOccurrence{}
...
func NewMaintenanceOccurrencesIdRespAttrsOccurrence() *MaintenanceOccurrencesIdRespAttrsOccurrence {
	this := MaintenanceOccurrencesIdRespAttrsOccurrence{}
	return &this
}
...
func (o MaintenanceOccurrencesIdRespAttrsOccurrence) MarshalJSON() ([]byte, error) {
...
type NullableMaintenanceOccurrencesIdRespAttrsOccurrence struct {
	value *MaintenanceOccurrencesIdRespAttrsOccurrence
	isSet bool
}

func (v NullableMaintenanceOccurrencesIdRespAttrsOccurrence) Get() *MaintenanceOccurrencesIdRespAttrsOccurrence {
	return v.value
}

func (v *NullableMaintenanceOccurrencesIdRespAttrsOccurrence) Set(val *MaintenanceOccurrencesIdRespAttrsOccurrence) {
	v.value = val
	v.isSet = true
}

func (v NullableMaintenanceOccurrencesIdRespAttrsOccurrence) IsSet() bool {
	return v.isSet
}

func (v *NullableMaintenanceOccurrencesIdRespAttrsOccurrence) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMaintenanceOccurrencesIdRespAttrsOccurrence(val *MaintenanceOccurrencesIdRespAttrsOccurrence) *NullableMaintenanceOccurrencesIdRespAttrsOccurrence {
	return &NullableMaintenanceOccurrencesIdRespAttrsOccurrence{value: val, isSet: true}
}

func (v NullableMaintenanceOccurrencesIdRespAttrsOccurrence) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMaintenanceOccurrencesIdRespAttrsOccurrence) UnmarshalJSON(src []byte) error {
	v.isSet = true
