...
// checks if the AlertingTeams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AlertingTeams{}
...
func (v NullableAlertingTeams) Get() *AlertingTeams {
	return v.value
}
...
func NewNullableAlertingTeams(val *AlertingTeams) *NullableAlertingTeams {
	return &NullableAlertingTeams{value: val, isSet: true}
}
