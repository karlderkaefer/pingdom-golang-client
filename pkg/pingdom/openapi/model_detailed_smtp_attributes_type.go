...
// checks if the DetailedSmtpAttributesType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DetailedSmtpAttributesType{}
...
func NewDetailedSmtpAttributesType() *DetailedSmtpAttributesType {
	this := DetailedSmtpAttributesType{}
	return &this
}
...
type NullableDetailedSmtpAttributesType struct {
	value *DetailedSmtpAttributesType
	isSet bool
}

func (v NullableDetailedSmtpAttributesType) Get() *DetailedSmtpAttributesType {
	return v.value
}

func (v *NullableDetailedSmtpAttributesType) Set(val *DetailedSmtpAttributesType) {
	v.value = val
	v.isSet = true
}

func (v NullableDetailedSmtpAttributesType) IsSet() bool {
	return v.isSet
}

func (v *NullableDetailedSmtpAttributesType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDetailedSmtpAttributesType(val *DetailedSmtpAttributesType) *NullableDetailedSmtpAttributesType {
	return &NullableDetailedSmtpAttributesType{value: val, isSet: true}
}
