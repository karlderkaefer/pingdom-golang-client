...
// checks if the HttpCustomAttributes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HttpCustomAttributes{}
...
type _HttpCustomAttributes HttpCustomAttributes
...
func (o *HttpCustomAttributes) UnmarshalJSON(data []byte) (err error) {
	...
	varHttpCustomAttributes := _HttpCustomAttributes{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varHttpCustomAttributes)

	if err != nil {
		return err
	}

	*o = HttpCustomAttributes(varHttpCustomAttributes)

	return err
}

type NullableHttpCustomAttributes struct {
	value *HttpCustomAttributes
	isSet bool
}

func (v NullableHttpCustomAttributes) Get() *HttpCustomAttributes {
	return v.value
}

func (v *NullableHttpCustomAttributes) Set(val *HttpCustomAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullableHttpCustomAttributes) IsSet() bool {
	return v.isSet
}
...
func NewNullableHttpCustomAttributes(val *HttpCustomAttributes) *NullableHttpCustomAttributes {
	return &NullableHttpCustomAttributes{value: val, isSet: true}
}
