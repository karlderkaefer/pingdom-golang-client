...
// checks if the ReportPerformanceReportIntervalsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReportPerformanceReportIntervalsInner{}
...
func NewReportPerformanceReportIntervalsInner() *ReportPerformanceReportIntervalsInner {
	this := ReportPerformanceReportIntervalsInner{}
	return &this
}
...
func (o *ReportPerformanceReportIntervalsInner) GetAverageResponse() int64 {
	if o == nil || IsNil(o.AverageResponse) {
		var ret int64
		return ret
	}
	return *o.AverageResponse
}

// GetAverageResponseOk returns a tuple with the AverageResponse field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ReportPerformanceReportIntervalsInner) GetAverageResponseOk() (*int64, bool) {
	if o == nil || IsNil(o.AverageResponse) {
		return nil, false
	}
	return o.AverageResponse, true
}
...
func (o *ReportPerformanceReportIntervalsInner) GetUnmonitored() int64 {
	if o == nil || IsNil(o.Unmonitored) {
		var ret int64
		return ret
	}
	return *o.Unmonitored
}

// GetUnmonitoredOk returns a tuple with the Unmonitored field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ReportPerformanceReportIntervalsInner) GetUnmonitoredOk() (*int64, bool) {
	if o == nil || IsNil(o.Unmonitored) {
		return nil, false
	}
	return o.Unmonitored, true
}
...
func (o *ReportPerformanceReportIntervalsInner) GetSteps() []ReportPerformanceReportIntervalsInnerStepsInner {
	if o == nil || IsNil(o.Steps) {
		var ret []ReportPerformanceReportIntervalsInnerStepsInner
		return ret
	}
	return o.Steps
}
...
func (o ReportPerformanceReportIntervalsInner) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.AverageResponse) {
		toSerialize["average_response"] = o.AverageResponse
	}
	if !IsNil(o.From) {
	...
	if !IsNil(o.Unmonitored) {
		toSerialize["unmonitored"] = o.Unmonitored
	}
	if !IsNil(o.Steps) {
...
type NullableReportPerformanceReportIntervalsInner struct {
	value *ReportPerformanceReportIntervalsInner
	isSet bool
}

func (v NullableReportPerformanceReportIntervalsInner) Get() *ReportPerformanceReportIntervalsInner {
	return v.value
}

func (v *NullableReportPerformanceReportIntervalsInner) Set(val *ReportPerformanceReportIntervalsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableReportPerformanceReportIntervalsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableReportPerformanceReportIntervalsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReportPerformanceReportIntervalsInner(val *ReportPerformanceReportIntervalsInner) *NullableReportPerformanceReportIntervalsInner {
	return &NullableReportPerformanceReportIntervalsInner{value: val, isSet: true}
}

func (v NullableReportPerformanceReportIntervalsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReportPerformanceReportIntervalsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
