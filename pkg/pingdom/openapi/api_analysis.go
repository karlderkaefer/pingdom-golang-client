...
func (r ApiAnalysisCheckidAnalysisidGetRequest) Execute() (*http.Response, error) {
	return r.ApiService.AnalysisCheckidAnalysisidGetExecute(r)
}
...
func (a *AnalysisAPIService) AnalysisCheckidAnalysisidGetExecute(r ApiAnalysisCheckidAnalysisidGetRequest) (*http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AnalysisAPIService.AnalysisCheckidAnalysisidGet")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/analysis/{checkid}/{analysisid}"
...
func (r ApiAnalysisCheckidGetRequest) Limit(limit int32) ApiAnalysisCheckidGetRequest {
	r.limit = &limit
	return r
}

// Offset for listing. (Requires limit.)
func (r ApiAnalysisCheckidGetRequest) Offset(offset int32) ApiAnalysisCheckidGetRequest {
	r.offset = &offset
	return r
}

// Return only results with timestamp of first test greater or equal to this value. Format is UNIX timestamp.
func (r ApiAnalysisCheckidGetRequest) From(from int32) ApiAnalysisCheckidGetRequest {
	r.from = &from
	return r
}
...
func (r ApiAnalysisCheckidGetRequest) To(to int32) ApiAnalysisCheckidGetRequest {
	r.to = &to
	return r
}

func (r ApiAnalysisCheckidGetRequest) Execute() (*AnalysisRespAttrs, *http.Response, error) {
	return r.ApiService.AnalysisCheckidGetExecute(r)
}
...
func (a *AnalysisAPIService) AnalysisCheckidGetExecute(r ApiAnalysisCheckidGetRequest) (*AnalysisRespAttrs, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *AnalysisRespAttrs
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AnalysisAPIService.AnalysisCheckidGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/analysis/{checkid}"
	localVarPath = strings.Replace(localVarPath, "{"+"checkid"+"}", url.PathEscape(parameterValueToString(r.checkid, "checkid")), -1)
