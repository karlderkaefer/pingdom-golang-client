...
// checks if the MaintenancePost type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MaintenancePost{}
...
type _MaintenancePost MaintenancePost
...
func NewMaintenancePost(description string, from int32, to int32) *MaintenancePost {
	this := MaintenancePost{}
	this.Description = description
	this.From = from
	this.To = to
	var recurrencetype string = "none"
	this.Recurrencetype = &recurrencetype
	var repeatevery int32 = 0
...
// GetUptimeidsOk returns a tuple with the Uptimeids field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MaintenancePost) GetUptimeidsOk() ([]int32, bool) {
	if o == nil || IsNil(o.Uptimeids) {
		return nil, false
	}
	return o.Uptimeids, true
}
...
// GetTmsidsOk returns a tuple with the Tmsids field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MaintenancePost) GetTmsidsOk() ([]int32, bool) {
	if o == nil || IsNil(o.Tmsids) {
		return nil, false
	}
	return o.Tmsids, true
}
...
func (o MaintenancePost) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.Uptimeids) {
		toSerialize["uptimeids"] = o.Uptimeids
	}
	if !IsNil(o.Tmsids) {
		toSerialize["tmsids"] = o.Tmsids
	}
...
func (o *MaintenancePost) UnmarshalJSON(data []byte) (err error) {
	...
	varMaintenancePost := _MaintenancePost{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMaintenancePost)

	if err != nil {
		return err
	}

	*o = MaintenancePost(varMaintenancePost)

	return err
}

type NullableMaintenancePost struct {
	value *MaintenancePost
	isSet bool
}

func (v NullableMaintenancePost) Get() *MaintenancePost {
	return v.value
}

func (v *NullableMaintenancePost) Set(val *MaintenancePost) {
	v.value = val
	v.isSet = true
}
...
func NewNullableMaintenancePost(val *MaintenancePost) *NullableMaintenancePost {
	return &NullableMaintenancePost{value: val, isSet: true}
}
