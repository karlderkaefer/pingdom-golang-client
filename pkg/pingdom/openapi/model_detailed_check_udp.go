...
// checks if the DetailedCheckUdp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DetailedCheckUdp{}
...
type NullableDetailedCheckUdp struct {
	value *DetailedCheckUdp
	isSet bool
}

func (v NullableDetailedCheckUdp) Get() *DetailedCheckUdp {
	return v.value
}

func (v *NullableDetailedCheckUdp) Set(val *DetailedCheckUdp) {
	v.value = val
	v.isSet = true
}
...
func NewNullableDetailedCheckUdp(val *DetailedCheckUdp) *NullableDetailedCheckUdp {
	return &NullableDetailedCheckUdp{value: val, isSet: true}
}
