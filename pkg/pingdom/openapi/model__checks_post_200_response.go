...
// checks if the ChecksPost200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ChecksPost200Response{}
...
func (o *ChecksPost200Response) GetCheck() ChecksPost200ResponseCheck {
	if o == nil || IsNil(o.Check) {
		var ret ChecksPost200ResponseCheck
		return ret
	}
	return *o.Check
}
...
type NullableChecksPost200Response struct {
	value *ChecksPost200Response
	isSet bool
}

func (v NullableChecksPost200Response) Get() *ChecksPost200Response {
	return v.value
}

func (v *NullableChecksPost200Response) Set(val *ChecksPost200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableChecksPost200Response) IsSet() bool {
	return v.isSet
}
...
func NewNullableChecksPost200Response(val *ChecksPost200Response) *NullableChecksPost200Response {
	return &NullableChecksPost200Response{value: val, isSet: true}
}
