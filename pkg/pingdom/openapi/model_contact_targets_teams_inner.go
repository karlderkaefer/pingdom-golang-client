...
// checks if the ContactTargetsTeamsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ContactTargetsTeamsInner{}
...
type NullableContactTargetsTeamsInner struct {
	value *ContactTargetsTeamsInner
	isSet bool
}

func (v NullableContactTargetsTeamsInner) Get() *ContactTargetsTeamsInner {
	return v.value
}

func (v *NullableContactTargetsTeamsInner) Set(val *ContactTargetsTeamsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableContactTargetsTeamsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableContactTargetsTeamsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableContactTargetsTeamsInner(val *ContactTargetsTeamsInner) *NullableContactTargetsTeamsInner {
	return &NullableContactTargetsTeamsInner{value: val, isSet: true}
}
