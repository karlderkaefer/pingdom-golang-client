...
// checks if the MaintenanceRespAttrs type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MaintenanceRespAttrs{}
...
func (o *MaintenanceRespAttrs) GetMaintenance() []MaintenanceRespAttrsMaintenanceInner {
	if o == nil || IsNil(o.Maintenance) {
		var ret []MaintenanceRespAttrsMaintenanceInner
		return ret
	}
...
type NullableMaintenanceRespAttrs struct {
	value *MaintenanceRespAttrs
	isSet bool
}

func (v NullableMaintenanceRespAttrs) Get() *MaintenanceRespAttrs {
	return v.value
}

func (v *NullableMaintenanceRespAttrs) Set(val *MaintenanceRespAttrs) {
	v.value = val
	v.isSet = true
}

func (v NullableMaintenanceRespAttrs) IsSet() bool {
	return v.isSet
}
...
func NewNullableMaintenanceRespAttrs(val *MaintenanceRespAttrs) *NullableMaintenanceRespAttrs {
	return &NullableMaintenanceRespAttrs{value: val, isSet: true}
}
