...
// checks if the ImapAttributes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ImapAttributes{}
...
type NullableImapAttributes struct {
	value *ImapAttributes
	isSet bool
}

func (v NullableImapAttributes) Get() *ImapAttributes {
	return v.value
}

func (v *NullableImapAttributes) Set(val *ImapAttributes) {
	v.value = val
	v.isSet = true
}
...
func NewNullableImapAttributes(val *ImapAttributes) *NullableImapAttributes {
	return &NullableImapAttributes{value: val, isSet: true}
}
