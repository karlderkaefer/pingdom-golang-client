...
// checks if the DetailedCheckSmtpCheck type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DetailedCheckSmtpCheck{}
...
func (o *DetailedCheckSmtpCheck) GetType() DetailedSmtpAttributesType {
	if o == nil || IsNil(o.Type) {
		var ret DetailedSmtpAttributesType
		return ret
	}
	return *o.Type
}
...
type NullableDetailedCheckSmtpCheck struct {
	value *DetailedCheckSmtpCheck
	isSet bool
}

func (v NullableDetailedCheckSmtpCheck) Get() *DetailedCheckSmtpCheck {
	return v.value
}

func (v *NullableDetailedCheckSmtpCheck) Set(val *DetailedCheckSmtpCheck) {
	v.value = val
	v.isSet = true
}

func (v NullableDetailedCheckSmtpCheck) IsSet() bool {
	return v.isSet
}
...
func NewNullableDetailedCheckSmtpCheck(val *DetailedCheckSmtpCheck) *NullableDetailedCheckSmtpCheck {
	return &NullableDetailedCheckSmtpCheck{value: val, isSet: true}
}
