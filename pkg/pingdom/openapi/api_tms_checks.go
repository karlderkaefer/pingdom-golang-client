...
*/
func (a *TMSChecksAPIService) AddCheck(ctx context.Context) ApiAddCheckRequest {
	return ApiAddCheckRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return CheckSimple
func (a *TMSChecksAPIService) AddCheckExecute(r ApiAddCheckRequest) (*CheckSimple, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *CheckSimple
	)
	...
	if r.checkWithoutID == nil {
		return localVarReturnValue, nil, reportError("checkWithoutID is required and must be specified")
	}
...
func (r ApiDeleteCheckRequest) Execute() (*DeleteCheck200Response, *http.Response, error) {
	return r.ApiService.DeleteCheckExecute(r)
}
...
*/
func (a *TMSChecksAPIService) DeleteCheck(ctx context.Context, cid int64) ApiDeleteCheckRequest {
	return ApiDeleteCheckRequest{
		ApiService: a,
		ctx: ctx,
		cid: cid,
...
func (a *TMSChecksAPIService) DeleteCheckExecute(r ApiDeleteCheckRequest) (*DeleteCheck200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodDelete
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *DeleteCheck200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TMSChecksAPIService.DeleteCheck")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiGetAllChecksRequest) Tags(tags []string) ApiGetAllChecksRequest {
	r.tags = &tags
	return r
}

// Filter to return only checks of a given type (a TMS &#x60;script&#x60; or a WPM &#x60;recording&#x60;). If not provided, all checks are returned.
func (r ApiGetAllChecksRequest) Type_(type_ string) ApiGetAllChecksRequest {
	r.type_ = &type_
	return r
}

// Limit of returned checks
func (r ApiGetAllChecksRequest) Limit(limit string) ApiGetAllChecksRequest {
	r.limit = &limit
	return r
}

// Offset of returned checks
func (r ApiGetAllChecksRequest) Offset(offset string) ApiGetAllChecksRequest {
	r.offset = &offset
	return r
}

func (r ApiGetAllChecksRequest) Execute() (*ChecksAll, *http.Response, error) {
	return r.ApiService.GetAllChecksExecute(r)
}
...
*/
func (a *TMSChecksAPIService) GetAllChecks(ctx context.Context) ApiGetAllChecksRequest {
	return ApiGetAllChecksRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *TMSChecksAPIService) GetAllChecksExecute(r ApiGetAllChecksRequest) (*ChecksAll, *http.Response, error) {
	var (
		...
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ChecksAll
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TMSChecksAPIService.GetAllChecks")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	if r.extendedTags != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "extended_tags", r.extendedTags, "")
	}
	if r.tags != nil {
...
func (r ApiGetCheckRequest) Execute() (*CheckWithoutIDGET, *http.Response, error) {
...
*/
func (a *TMSChecksAPIService) GetCheck(ctx context.Context, cid int64) ApiGetCheckRequest {
	return ApiGetCheckRequest{
		ApiService: a,
		ctx: ctx,
		cid: cid,
...
func (a *TMSChecksAPIService) GetCheckExecute(r ApiGetCheckRequest) (*CheckWithoutIDGET, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *CheckWithoutIDGET
	)
...
func (r ApiGetCheckReportPerformanceRequest) From(from time.Time) ApiGetCheckReportPerformanceRequest {
	r.from = &from
	return r
}
...
func (r ApiGetCheckReportPerformanceRequest) To(to time.Time) ApiGetCheckReportPerformanceRequest {
	r.to = &to
	return r
}

// Sorting order of outages. Ascending or descending
func (r ApiGetCheckReportPerformanceRequest) Order(order string) ApiGetCheckReportPerformanceRequest {
	r.order = &order
	return r
}
...
func (r ApiGetCheckReportPerformanceRequest) Resolution(resolution string) ApiGetCheckReportPerformanceRequest {
	r.resolution = &resolution
	return r
}

// Include uptime information. Adds field downtime, uptime, and unmonitored to the interval array objects.
func (r ApiGetCheckReportPerformanceRequest) IncludeUptime(includeUptime bool) ApiGetCheckReportPerformanceRequest {
	r.includeUptime = &includeUptime
	return r
}

func (r ApiGetCheckReportPerformanceRequest) Execute() (*ReportPerformance, *http.Response, error) {
	return r.ApiService.GetCheckReportPerformanceExecute(r)
}
...
func (a *TMSChecksAPIService) GetCheckReportPerformanceExecute(r ApiGetCheckReportPerformanceRequest) (*ReportPerformance, *http.Response, error) {
	var (
		...
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ReportPerformance
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TMSChecksAPIService.GetCheckReportPerformance")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/tms/check/{check_id}/report/performance"
	...
	if r.includeUptime != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "include_uptime", r.includeUptime, "")
	} else {
		var defaultValue bool = false
		r.includeUptime = &defaultValue
	}
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
...
func (r ApiGetCheckReportStatusRequest) From(from time.Time) ApiGetCheckReportStatusRequest {
	r.from = &from
	return r
}

// End time of period. The format is &#x60;RFC 3339&#x60; (properly URL-encoded!). The default value is the current time
func (r ApiGetCheckReportStatusRequest) To(to time.Time) ApiGetCheckReportStatusRequest {
	r.to = &to
	return r
}

// Sorting order of outages. Ascending or descending
func (r ApiGetCheckReportStatusRequest) Order(order string) ApiGetCheckReportStatusRequest {
	r.order = &order
	return r
}

func (r ApiGetCheckReportStatusRequest) Execute() (*ReportStatusSingle, *http.Response, error) {
	return r.ApiService.GetCheckReportStatusExecute(r)
}
...
func (a *TMSChecksAPIService) GetCheckReportStatusExecute(r ApiGetCheckReportStatusRequest) (*ReportStatusSingle, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ReportStatusSingle
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TMSChecksAPIService.GetCheckReportStatus")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/tms/check/{check_id}/report/status"
	localVarPath = strings.Replace(localVarPath, "{"+"check_id"+"}", url.PathEscape(parameterValueToString(r.checkId, "checkId")), -1)
...
// Start time of period. The format is &#x60;RFC 3339&#x60; (properly URL-encoded!). The default value is one week earlier than &#x60;to&#x60;
func (r ApiGetCheckReportStatusAllRequest) From(from time.Time) ApiGetCheckReportStatusAllRequest {
	r.from = &from
	return r
}

// End time of period. The format is &#x60;RFC 3339&#x60; (properly URL-encoded!). The default value is the current time
func (r ApiGetCheckReportStatusAllRequest) To(to time.Time) ApiGetCheckReportStatusAllRequest {
	r.to = &to
	return r
}

// Sorting order of outages. Ascending or descending
func (r ApiGetCheckReportStatusAllRequest) Order(order string) ApiGetCheckReportStatusAllRequest {
	r.order = &order
	return r
}

// Limit of returned checks
func (r ApiGetCheckReportStatusAllRequest) Limit(limit string) ApiGetCheckReportStatusAllRequest {
	r.limit = &limit
	return r
}

// Offset of returned checks
func (r ApiGetCheckReportStatusAllRequest) Offset(offset string) ApiGetCheckReportStatusAllRequest {
	r.offset = &offset
	return r
}

// Omits checks without any results within specified time
func (r ApiGetCheckReportStatusAllRequest) OmitEmpty(omitEmpty bool) ApiGetCheckReportStatusAllRequest {
	r.omitEmpty = &omitEmpty
	return r
}

func (r ApiGetCheckReportStatusAllRequest) Execute() (*ReportStatusAll, *http.Response, error) {
	return r.ApiService.GetCheckReportStatusAllExecute(r)
}
...
func (a *TMSChecksAPIService) GetCheckReportStatusAllExecute(r ApiGetCheckReportStatusAllRequest) (*ReportStatusAll, *http.Response, error) {
	var (
		...
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ReportStatusAll
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TMSChecksAPIService.GetCheckReportStatusAll")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/tms/check/report/status"
	...
	if r.omitEmpty != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "omit_empty", r.omitEmpty, "")
	} else {
		var defaultValue bool = false
		r.omitEmpty = &defaultValue
	}
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
...
type ApiModifyCheckRequest struct {
	...
	ApiService *TMSChecksAPIService
	cid int64
	checkWithoutIDPUT *CheckWithoutIDPUT
}
...
func (r ApiModifyCheckRequest) CheckWithoutIDPUT(checkWithoutIDPUT CheckWithoutIDPUT) ApiModifyCheckRequest {
	r.checkWithoutIDPUT = &checkWithoutIDPUT
	return r
}

func (r ApiModifyCheckRequest) Execute() (*CheckWithoutIDGET, *http.Response, error) {
	return r.ApiService.ModifyCheckExecute(r)
}
...
*/
func (a *TMSChecksAPIService) ModifyCheck(ctx context.Context, cid int64) ApiModifyCheckRequest {
	return ApiModifyCheckRequest{
		ApiService: a,
		ctx: ctx,
		cid: cid,
...
// Execute executes the request
//  @return CheckWithoutIDGET
func (a *TMSChecksAPIService) ModifyCheckExecute(r ApiModifyCheckRequest) (*CheckWithoutIDGET, *http.Response, error) {
	var (
	...
	if r.checkWithoutIDPUT == nil {
		return localVarReturnValue, nil, reportError("checkWithoutIDPUT is required and must be specified")
	}
