...
// checks if the SummaryOutageRespAttrsSummaryStatesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SummaryOutageRespAttrsSummaryStatesInner{}
...
func NewSummaryOutageRespAttrsSummaryStatesInner() *SummaryOutageRespAttrsSummaryStatesInner {
	this := SummaryOutageRespAttrsSummaryStatesInner{}
	return &this
}
...
func (o SummaryOutageRespAttrsSummaryStatesInner) MarshalJSON() ([]byte, error) {
...
func (o SummaryOutageRespAttrsSummaryStatesInner) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.Timeto) {
		toSerialize["timeto"] = o.Timeto
	}
	return toSerialize, nil
}

type NullableSummaryOutageRespAttrsSummaryStatesInner struct {
	value *SummaryOutageRespAttrsSummaryStatesInner
	isSet bool
}

func (v NullableSummaryOutageRespAttrsSummaryStatesInner) Get() *SummaryOutageRespAttrsSummaryStatesInner {
	return v.value
}

func (v *NullableSummaryOutageRespAttrsSummaryStatesInner) Set(val *SummaryOutageRespAttrsSummaryStatesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableSummaryOutageRespAttrsSummaryStatesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableSummaryOutageRespAttrsSummaryStatesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSummaryOutageRespAttrsSummaryStatesInner(val *SummaryOutageRespAttrsSummaryStatesInner) *NullableSummaryOutageRespAttrsSummaryStatesInner {
	return &NullableSummaryOutageRespAttrsSummaryStatesInner{value: val, isSet: true}
}

func (v NullableSummaryOutageRespAttrsSummaryStatesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSummaryOutageRespAttrsSummaryStatesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
