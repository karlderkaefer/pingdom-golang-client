...
// checks if the SummaryRespAttrsSummary type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SummaryRespAttrsSummary{}
...
func (o *SummaryRespAttrsSummary) GetResponsetime() SummaryRespAttrsSummaryResponsetime {
	if o == nil || IsNil(o.Responsetime) {
		var ret SummaryRespAttrsSummaryResponsetime
		return ret
	}
...
func (o *SummaryRespAttrsSummary) GetStatus() SummaryRespAttrsSummaryStatus {
	if o == nil || IsNil(o.Status) {
		var ret SummaryRespAttrsSummaryStatus
		return ret
	}
	return *o.Status
}
...
type NullableSummaryRespAttrsSummary struct {
	value *SummaryRespAttrsSummary
	isSet bool
}

func (v NullableSummaryRespAttrsSummary) Get() *SummaryRespAttrsSummary {
	return v.value
}

func (v *NullableSummaryRespAttrsSummary) Set(val *SummaryRespAttrsSummary) {
	v.value = val
	v.isSet = true
}

func (v NullableSummaryRespAttrsSummary) IsSet() bool {
	return v.isSet
}

func (v *NullableSummaryRespAttrsSummary) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSummaryRespAttrsSummary(val *SummaryRespAttrsSummary) *NullableSummaryRespAttrsSummary {
	return &NullableSummaryRespAttrsSummary{value: val, isSet: true}
}
