...
func (r ApiCreditsGetRequest) Execute() (*CreditsRespAttrs, *http.Response, error) {
	return r.ApiService.CreditsGetExecute(r)
}
...
*/
func (a *CreditsAPIService) CreditsGet(ctx context.Context) ApiCreditsGetRequest {
	return ApiCreditsGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *CreditsAPIService) CreditsGetExecute(r ApiCreditsGetRequest) (*CreditsRespAttrs, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *CreditsRespAttrs
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CreditsAPIService.CreditsGet")
	if err != nil {
