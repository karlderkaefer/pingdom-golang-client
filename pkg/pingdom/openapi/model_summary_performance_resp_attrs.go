...
// checks if the SummaryPerformanceRespAttrs type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SummaryPerformanceRespAttrs{}
...
func NewSummaryPerformanceRespAttrs() *SummaryPerformanceRespAttrs {
	this := SummaryPerformanceRespAttrs{}
	return &this
}
...
func (o *SummaryPerformanceRespAttrs) GetSummary() SummaryPerformanceRespAttrsSummary {
	if o == nil || IsNil(o.Summary) {
		var ret SummaryPerformanceRespAttrsSummary
		return ret
	}
	return *o.Summary
}
...
type NullableSummaryPerformanceRespAttrs struct {
	value *SummaryPerformanceRespAttrs
	isSet bool
}

func (v NullableSummaryPerformanceRespAttrs) Get() *SummaryPerformanceRespAttrs {
	return v.value
}

func (v *NullableSummaryPerformanceRespAttrs) Set(val *SummaryPerformanceRespAttrs) {
	v.value = val
	v.isSet = true
}

func (v NullableSummaryPerformanceRespAttrs) IsSet() bool {
	return v.isSet
}

func (v *NullableSummaryPerformanceRespAttrs) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSummaryPerformanceRespAttrs(val *SummaryPerformanceRespAttrs) *NullableSummaryPerformanceRespAttrs {
	return &NullableSummaryPerformanceRespAttrs{value: val, isSet: true}
}
