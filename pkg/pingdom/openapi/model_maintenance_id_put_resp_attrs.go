...
// checks if the MaintenanceIdPutRespAttrs type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MaintenanceIdPutRespAttrs{}
...
func NewMaintenanceIdPutRespAttrs() *MaintenanceIdPutRespAttrs {
	this := MaintenanceIdPutRespAttrs{}
	return &this
}
...
type NullableMaintenanceIdPutRespAttrs struct {
	value *MaintenanceIdPutRespAttrs
	isSet bool
}

func (v NullableMaintenanceIdPutRespAttrs) Get() *MaintenanceIdPutRespAttrs {
	return v.value
}

func (v *NullableMaintenanceIdPutRespAttrs) Set(val *MaintenanceIdPutRespAttrs) {
	v.value = val
	v.isSet = true
}

func (v NullableMaintenanceIdPutRespAttrs) IsSet() bool {
	return v.isSet
}

func (v *NullableMaintenanceIdPutRespAttrs) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMaintenanceIdPutRespAttrs(val *MaintenanceIdPutRespAttrs) *NullableMaintenanceIdPutRespAttrs {
	return &NullableMaintenanceIdPutRespAttrs{value: val, isSet: true}
}
