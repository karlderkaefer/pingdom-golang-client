...
// checks if the TcpAttributes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TcpAttributes{}
...
type _TcpAttributes TcpAttributes
...
// GetStringtosendOk returns a tuple with the Stringtosend field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *TcpAttributes) GetStringtosendOk() (*string, bool) {
	if o == nil || IsNil(o.Stringtosend) {
		return nil, false
	}
	return o.Stringtosend, true
}
...
func (o TcpAttributes) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.Stringtosend) {
		toSerialize["stringtosend"] = o.Stringtosend
	}
...
func (o *TcpAttributes) UnmarshalJSON(data []byte) (err error) {
	...
	varTcpAttributes := _TcpAttributes{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTcpAttributes)

	if err != nil {
		return err
	}

	*o = TcpAttributes(varTcpAttributes)
...
func (v NullableTcpAttributes) Get() *TcpAttributes {
	return v.value
}
...
func NewNullableTcpAttributes(val *TcpAttributes) *NullableTcpAttributes {
	return &NullableTcpAttributes{value: val, isSet: true}
}
