...
// checks if the HttpAttributesSet type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HttpAttributesSet{}
...
type NullableHttpAttributesSet struct {
	value *HttpAttributesSet
	isSet bool
}

func (v NullableHttpAttributesSet) Get() *HttpAttributesSet {
	return v.value
}

func (v *NullableHttpAttributesSet) Set(val *HttpAttributesSet) {
	v.value = val
	v.isSet = true
}
...
func NewNullableHttpAttributesSet(val *HttpAttributesSet) *NullableHttpAttributesSet {
	return &NullableHttpAttributesSet{value: val, isSet: true}
}
