...
type ApiMaintenanceOccurrencesDeleteRequest struct {
	...
	occurenceids *MaintenanceOccurrencesDelete
}

func (r ApiMaintenanceOccurrencesDeleteRequest) Occurenceids(occurenceids MaintenanceOccurrencesDelete) ApiMaintenanceOccurrencesDeleteRequest {
	r.occurenceids = &occurenceids
	return r
}

func (r ApiMaintenanceOccurrencesDeleteRequest) Execute() (*MaintenanceOccurrencesDeleteRespAttrs, *http.Response, error) {
	return r.ApiService.MaintenanceOccurrencesDeleteExecute(r)
}
...
*/
func (a *MaintenanceOccurrencesAPIService) MaintenanceOccurrencesDelete(ctx context.Context) ApiMaintenanceOccurrencesDeleteRequest {
	return ApiMaintenanceOccurrencesDeleteRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *MaintenanceOccurrencesAPIService) MaintenanceOccurrencesDeleteExecute(r ApiMaintenanceOccurrencesDeleteRequest) (*MaintenanceOccurrencesDeleteRespAttrs, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodDelete
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *MaintenanceOccurrencesDeleteRespAttrs
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MaintenanceOccurrencesAPIService.MaintenanceOccurrencesDelete")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/maintenance.occurrences"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.occurenceids == nil {
		return localVarReturnValue, nil, reportError("occurenceids is required and must be specified")
	}

	parameterAddToHeaderOrQuery(localVarQueryParams, "occurenceids", r.occurenceids, "")
...
func (r ApiMaintenanceOccurrencesGetRequest) Maintenanceid(maintenanceid int32) ApiMaintenanceOccurrencesGetRequest {
...
func (r ApiMaintenanceOccurrencesGetRequest) From(from int32) ApiMaintenanceOccurrencesGetRequest {
	r.from = &from
	return r
}

// Effective to (unix timestamp). (List occurrences which are effective to the specified unix timestamp.)
func (r ApiMaintenanceOccurrencesGetRequest) To(to int32) ApiMaintenanceOccurrencesGetRequest {
	r.to = &to
	return r
}

func (r ApiMaintenanceOccurrencesGetRequest) Execute() (*MaintenanceOccurrencesRespAttrs, *http.Response, error) {
	return r.ApiService.MaintenanceOccurrencesGetExecute(r)
}
...
*/
func (a *MaintenanceOccurrencesAPIService) MaintenanceOccurrencesGet(ctx context.Context) ApiMaintenanceOccurrencesGetRequest {
	return ApiMaintenanceOccurrencesGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *MaintenanceOccurrencesAPIService) MaintenanceOccurrencesGetExecute(r ApiMaintenanceOccurrencesGetRequest) (*MaintenanceOccurrencesRespAttrs, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *MaintenanceOccurrencesRespAttrs
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MaintenanceOccurrencesAPIService.MaintenanceOccurrencesGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiMaintenanceOccurrencesIdDeleteRequest) Execute() (*MaintenanceOccurrencesIdDeleteRespAttrs, *http.Response, error) {
	return r.ApiService.MaintenanceOccurrencesIdDeleteExecute(r)
}
...
*/
func (a *MaintenanceOccurrencesAPIService) MaintenanceOccurrencesIdDelete(ctx context.Context, id int32) ApiMaintenanceOccurrencesIdDeleteRequest {
	return ApiMaintenanceOccurrencesIdDeleteRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
func (a *MaintenanceOccurrencesAPIService) MaintenanceOccurrencesIdDeleteExecute(r ApiMaintenanceOccurrencesIdDeleteRequest) (*MaintenanceOccurrencesIdDeleteRespAttrs, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodDelete
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *MaintenanceOccurrencesIdDeleteRespAttrs
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MaintenanceOccurrencesAPIService.MaintenanceOccurrencesIdDelete")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/maintenance.occurrences/{id}"
...
func (r ApiMaintenanceOccurrencesIdGetRequest) Execute() (*MaintenanceOccurrencesIdRespAttrs, *http.Response, error) {
	return r.ApiService.MaintenanceOccurrencesIdGetExecute(r)
}
...
*/
func (a *MaintenanceOccurrencesAPIService) MaintenanceOccurrencesIdGet(ctx context.Context, id int32) ApiMaintenanceOccurrencesIdGetRequest {
	return ApiMaintenanceOccurrencesIdGetRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
func (a *MaintenanceOccurrencesAPIService) MaintenanceOccurrencesIdGetExecute(r ApiMaintenanceOccurrencesIdGetRequest) (*MaintenanceOccurrencesIdRespAttrs, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *MaintenanceOccurrencesIdRespAttrs
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MaintenanceOccurrencesAPIService.MaintenanceOccurrencesIdGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiMaintenanceOccurrencesIdPutRequest struct {
	...
	ApiService *MaintenanceOccurrencesAPIService
	id int32
	maintenanceOccurrencesIdPut *MaintenanceOccurrencesIdPut
}
...
func (r ApiMaintenanceOccurrencesIdPutRequest) MaintenanceOccurrencesIdPut(maintenanceOccurrencesIdPut MaintenanceOccurrencesIdPut) ApiMaintenanceOccurrencesIdPutRequest {
	r.maintenanceOccurrencesIdPut = &maintenanceOccurrencesIdPut
	return r
}

func (r ApiMaintenanceOccurrencesIdPutRequest) Execute() (*MaintenanceOccurrencesIdPutRespAttrs, *http.Response, error) {
	return r.ApiService.MaintenanceOccurrencesIdPutExecute(r)
}
...
*/
func (a *MaintenanceOccurrencesAPIService) MaintenanceOccurrencesIdPut(ctx context.Context, id int32) ApiMaintenanceOccurrencesIdPutRequest {
	return ApiMaintenanceOccurrencesIdPutRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
func (a *MaintenanceOccurrencesAPIService) MaintenanceOccurrencesIdPutExecute(r ApiMaintenanceOccurrencesIdPutRequest) (*MaintenanceOccurrencesIdPutRespAttrs, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *MaintenanceOccurrencesIdPutRespAttrs
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MaintenanceOccurrencesAPIService.MaintenanceOccurrencesIdPut")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.maintenanceOccurrencesIdPut == nil {
		return localVarReturnValue, nil, reportError("maintenanceOccurrencesIdPut is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.maintenanceOccurrencesIdPut
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
