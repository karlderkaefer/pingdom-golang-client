...
// checks if the DetailedPop3AttributesType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DetailedPop3AttributesType{}
...
func NewDetailedPop3AttributesType() *DetailedPop3AttributesType {
	this := DetailedPop3AttributesType{}
	return &this
}
...
func (o *DetailedPop3AttributesType) GetPop3() Pop3Attributes {
	if o == nil || IsNil(o.Pop3) {
		var ret Pop3Attributes
		return ret
	}
	return *o.Pop3
}

// GetPop3Ok returns a tuple with the Pop3 field value if set, nil otherwise
...
func (o DetailedPop3AttributesType) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.Pop3) {
		toSerialize["pop3"] = o.Pop3
	}
	return toSerialize, nil
}

type NullableDetailedPop3AttributesType struct {
	value *DetailedPop3AttributesType
	isSet bool
}

func (v NullableDetailedPop3AttributesType) Get() *DetailedPop3AttributesType {
	return v.value
}

func (v *NullableDetailedPop3AttributesType) Set(val *DetailedPop3AttributesType) {
	v.value = val
	v.isSet = true
}

func (v NullableDetailedPop3AttributesType) IsSet() bool {
	return v.isSet
}

func (v *NullableDetailedPop3AttributesType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDetailedPop3AttributesType(val *DetailedPop3AttributesType) *NullableDetailedPop3AttributesType {
	return &NullableDetailedPop3AttributesType{value: val, isSet: true}
}
