...
func (dst *CreateContactNotificationTargets) UnmarshalJSON(data []byte) error {
	...
	return fmt.Errorf("data failed to match schemas in anyOf(CreateContactNotificationTargets)")
}
...
type NullableCreateContactNotificationTargets struct {
	value *CreateContactNotificationTargets
	isSet bool
}

func (v NullableCreateContactNotificationTargets) Get() *CreateContactNotificationTargets {
	return v.value
}

func (v *NullableCreateContactNotificationTargets) Set(val *CreateContactNotificationTargets) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateContactNotificationTargets) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateContactNotificationTargets) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateContactNotificationTargets(val *CreateContactNotificationTargets) *NullableCreateContactNotificationTargets {
	return &NullableCreateContactNotificationTargets{value: val, isSet: true}
}

func (v NullableCreateContactNotificationTargets) MarshalJSON() ([]byte, error) {
