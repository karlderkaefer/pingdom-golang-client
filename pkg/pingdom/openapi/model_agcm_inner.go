...
// checks if the AGCMInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AGCMInner{}
...
// GetAgcmIdOk returns a tuple with the AgcmId field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AGCMInner) GetAgcmIdOk() (*string, bool) {
	if o == nil || IsNil(o.AgcmId) {
		return nil, false
	}
	return o.AgcmId, true
}
...
func NewNullableAGCMInner(val *AGCMInner) *NullableAGCMInner {
	return &NullableAGCMInner{value: val, isSet: true}
}
