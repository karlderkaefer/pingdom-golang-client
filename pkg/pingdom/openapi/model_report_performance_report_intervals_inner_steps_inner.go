...
// checks if the ReportPerformanceReportIntervalsInnerStepsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReportPerformanceReportIntervalsInnerStepsInner{}
...
func NewReportPerformanceReportIntervalsInnerStepsInner() *ReportPerformanceReportIntervalsInnerStepsInner {
	this := ReportPerformanceReportIntervalsInnerStepsInner{}
	return &this
}
...
func (o ReportPerformanceReportIntervalsInnerStepsInner) MarshalJSON() ([]byte, error) {
...
type NullableReportPerformanceReportIntervalsInnerStepsInner struct {
	value *ReportPerformanceReportIntervalsInnerStepsInner
	isSet bool
}

func (v NullableReportPerformanceReportIntervalsInnerStepsInner) Get() *ReportPerformanceReportIntervalsInnerStepsInner {
	return v.value
}

func (v *NullableReportPerformanceReportIntervalsInnerStepsInner) Set(val *ReportPerformanceReportIntervalsInnerStepsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableReportPerformanceReportIntervalsInnerStepsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableReportPerformanceReportIntervalsInnerStepsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReportPerformanceReportIntervalsInnerStepsInner(val *ReportPerformanceReportIntervalsInnerStepsInner) *NullableReportPerformanceReportIntervalsInnerStepsInner {
	return &NullableReportPerformanceReportIntervalsInnerStepsInner{value: val, isSet: true}
}

func (v NullableReportPerformanceReportIntervalsInnerStepsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReportPerformanceReportIntervalsInnerStepsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
