...
// checks if the DetailedCheckSmtp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DetailedCheckSmtp{}
...
func (o *DetailedCheckSmtp) GetCheck() DetailedCheckSmtpCheck {
	if o == nil || IsNil(o.Check) {
		var ret DetailedCheckSmtpCheck
		return ret
	}
	return *o.Check
}
...
type NullableDetailedCheckSmtp struct {
	value *DetailedCheckSmtp
	isSet bool
}

func (v NullableDetailedCheckSmtp) Get() *DetailedCheckSmtp {
	return v.value
}

func (v *NullableDetailedCheckSmtp) Set(val *DetailedCheckSmtp) {
	v.value = val
	v.isSet = true
}
...
func NewNullableDetailedCheckSmtp(val *DetailedCheckSmtp) *NullableDetailedCheckSmtp {
	return &NullableDetailedCheckSmtp{value: val, isSet: true}
}
