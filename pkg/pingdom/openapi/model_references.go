...
func (o *References) GetDatetimeformats() []DateTimeFormat {
	if o == nil || IsNil(o.Datetimeformats) {
		var ret []DateTimeFormat
		return ret
	}
	return o.Datetimeformats
}

// GetDatetimeformatsOk returns a tuple with the Datetimeformats field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *References) GetDatetimeformatsOk() ([]DateTimeFormat, bool) {
	if o == nil || IsNil(o.Datetimeformats) {
		return nil, false
	}
	return o.Datetimeformats, true
}
...
func (o *References) GetNumberformats() []NumberFormat {
	if o == nil || IsNil(o.Numberformats) {
		var ret []NumberFormat
		return ret
	}
	return o.Numberformats
}

// GetNumberformatsOk returns a tuple with the Numberformats field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *References) GetNumberformatsOk() ([]NumberFormat, bool) {
	if o == nil || IsNil(o.Numberformats) {
		return nil, false
	}
	return o.Numberformats, true
}
...
// GetPhonecodesOk returns a tuple with the Phonecodes field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *References) GetPhonecodesOk() ([]PhoneCode, bool) {
	if o == nil || IsNil(o.Phonecodes) {
		return nil, false
	}
	return o.Phonecodes, true
}
...
func (o References) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.Datetimeformats) {
		toSerialize["datetimeformats"] = o.Datetimeformats
	}
	if !IsNil(o.Numberformats) {
		toSerialize["numberformats"] = o.Numberformats
	}
	if !IsNil(o.Countries) {
		toSerialize["countries"] = o.Countries
	}
	if !IsNil(o.Phonecodes) {
		toSerialize["phonecodes"] = o.Phonecodes
	}
