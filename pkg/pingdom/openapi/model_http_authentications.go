...
// checks if the HttpAuthentications type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HttpAuthentications{}
...
func (o *HttpAuthentications) GetCredentials() HttpAuthenticationsCredentials {
	if o == nil || IsNil(o.Credentials) {
		var ret HttpAuthenticationsCredentials
		return ret
	}
...
type NullableHttpAuthentications struct {
	value *HttpAuthentications
	isSet bool
}

func (v NullableHttpAuthentications) Get() *HttpAuthentications {
	return v.value
}

func (v *NullableHttpAuthentications) Set(val *HttpAuthentications) {
	v.value = val
	v.isSet = true
}

func (v NullableHttpAuthentications) IsSet() bool {
	return v.isSet
}
...
func NewNullableHttpAuthentications(val *HttpAuthentications) *NullableHttpAuthentications {
	return &NullableHttpAuthentications{value: val, isSet: true}
}
