...
// checks if the AlertingContactsPost200ResponseContact type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AlertingContactsPost200ResponseContact{}
...
func NewAlertingContactsPost200ResponseContact() *AlertingContactsPost200ResponseContact {
	this := AlertingContactsPost200ResponseContact{}
	return &this
}
...
type NullableAlertingContactsPost200ResponseContact struct {
	value *AlertingContactsPost200ResponseContact
	isSet bool
}

func (v NullableAlertingContactsPost200ResponseContact) Get() *AlertingContactsPost200ResponseContact {
	return v.value
}

func (v *NullableAlertingContactsPost200ResponseContact) Set(val *AlertingContactsPost200ResponseContact) {
	v.value = val
	v.isSet = true
}

func (v NullableAlertingContactsPost200ResponseContact) IsSet() bool {
	return v.isSet
}

func (v *NullableAlertingContactsPost200ResponseContact) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAlertingContactsPost200ResponseContact(val *AlertingContactsPost200ResponseContact) *NullableAlertingContactsPost200ResponseContact {
	return &NullableAlertingContactsPost200ResponseContact{value: val, isSet: true}
}

func (v NullableAlertingContactsPost200ResponseContact) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAlertingContactsPost200ResponseContact) UnmarshalJSON(src []byte) error {
	v.isSet = true
