...
// checks if the SummaryRespAttrsSummaryStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SummaryRespAttrsSummaryStatus{}
...
func NewSummaryRespAttrsSummaryStatus() *SummaryRespAttrsSummaryStatus {
	this := SummaryRespAttrsSummaryStatus{}
	return &this
}
...
// GetTotalunknownOk returns a tuple with the Totalunknown field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
func (o SummaryRespAttrsSummaryStatus) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.Totalunknown) {
		toSerialize["totalunknown"] = o.Totalunknown
	}
	return toSerialize, nil
}

type NullableSummaryRespAttrsSummaryStatus struct {
	value *SummaryRespAttrsSummaryStatus
	isSet bool
}

func (v NullableSummaryRespAttrsSummaryStatus) Get() *SummaryRespAttrsSummaryStatus {
	return v.value
}

func (v *NullableSummaryRespAttrsSummaryStatus) Set(val *SummaryRespAttrsSummaryStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableSummaryRespAttrsSummaryStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableSummaryRespAttrsSummaryStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSummaryRespAttrsSummaryStatus(val *SummaryRespAttrsSummaryStatus) *NullableSummaryRespAttrsSummaryStatus {
	return &NullableSummaryRespAttrsSummaryStatus{value: val, isSet: true}
}
