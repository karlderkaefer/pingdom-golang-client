...
// checks if the DetailedCheckHttpCustom type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DetailedCheckHttpCustom{}
...
func (o *DetailedCheckHttpCustom) GetCheck() DetailedCheckHttpCustomCheck {
	if o == nil || IsNil(o.Check) {
		var ret DetailedCheckHttpCustomCheck
		return ret
	}
	return *o.Check
}
...
type NullableDetailedCheckHttpCustom struct {
	value *DetailedCheckHttpCustom
	isSet bool
}

func (v NullableDetailedCheckHttpCustom) Get() *DetailedCheckHttpCustom {
	return v.value
}

func (v *NullableDetailedCheckHttpCustom) Set(val *DetailedCheckHttpCustom) {
	v.value = val
	v.isSet = true
}

func (v NullableDetailedCheckHttpCustom) IsSet() bool {
	return v.isSet
}

func (v *NullableDetailedCheckHttpCustom) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDetailedCheckHttpCustom(val *DetailedCheckHttpCustom) *NullableDetailedCheckHttpCustom {
	return &NullableDetailedCheckHttpCustom{value: val, isSet: true}
}
