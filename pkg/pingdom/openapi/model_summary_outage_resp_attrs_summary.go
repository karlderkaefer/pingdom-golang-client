...
// checks if the SummaryOutageRespAttrsSummary type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SummaryOutageRespAttrsSummary{}
...
func NewSummaryOutageRespAttrsSummary() *SummaryOutageRespAttrsSummary {
	this := SummaryOutageRespAttrsSummary{}
	return &this
}
...
func (o *SummaryOutageRespAttrsSummary) GetStates() []SummaryOutageRespAttrsSummaryStatesInner {
	if o == nil || IsNil(o.States) {
		var ret []SummaryOutageRespAttrsSummaryStatesInner
		return ret
	}
	return o.States
}
...
type NullableSummaryOutageRespAttrsSummary struct {
	value *SummaryOutageRespAttrsSummary
	isSet bool
}

func (v NullableSummaryOutageRespAttrsSummary) Get() *SummaryOutageRespAttrsSummary {
	return v.value
}

func (v *NullableSummaryOutageRespAttrsSummary) Set(val *SummaryOutageRespAttrsSummary) {
	v.value = val
	v.isSet = true
}

func (v NullableSummaryOutageRespAttrsSummary) IsSet() bool {
	return v.isSet
}

func (v *NullableSummaryOutageRespAttrsSummary) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSummaryOutageRespAttrsSummary(val *SummaryOutageRespAttrsSummary) *NullableSummaryOutageRespAttrsSummary {
	return &NullableSummaryOutageRespAttrsSummary{value: val, isSet: true}
}
