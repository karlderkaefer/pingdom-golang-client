...
// checks if the TracerouteData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TracerouteData{}
...
func (o *TracerouteData) GetProbedescription() string {
	if o == nil || IsNil(o.Probedescription) {
		var ret string
		return ret
	}
	return *o.Probedescription
}

// GetProbedescriptionOk returns a tuple with the Probedescription field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *TracerouteData) GetProbedescriptionOk() (*string, bool) {
	if o == nil || IsNil(o.Probedescription) {
		return nil, false
	}
	return o.Probedescription, true
}
...
func (o TracerouteData) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.Probedescription) {
		toSerialize["probedescription"] = o.Probedescription
	}
	return toSerialize, nil
}

type NullableTracerouteData struct {
	value *TracerouteData
	isSet bool
}

func (v NullableTracerouteData) Get() *TracerouteData {
	return v.value
}

func (v *NullableTracerouteData) Set(val *TracerouteData) {
	v.value = val
	v.isSet = true
}
...
func NewNullableTracerouteData(val *TracerouteData) *NullableTracerouteData {
	return &NullableTracerouteData{value: val, isSet: true}
}
