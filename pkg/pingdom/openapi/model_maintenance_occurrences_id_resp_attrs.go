...
// checks if the MaintenanceOccurrencesIdRespAttrs type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MaintenanceOccurrencesIdRespAttrs{}
...
func NewMaintenanceOccurrencesIdRespAttrs() *MaintenanceOccurrencesIdRespAttrs {
	this := MaintenanceOccurrencesIdRespAttrs{}
	return &this
}
...
func (o *MaintenanceOccurrencesIdRespAttrs) GetOccurrence() MaintenanceOccurrencesIdRespAttrsOccurrence {
	if o == nil || IsNil(o.Occurrence) {
		var ret MaintenanceOccurrencesIdRespAttrsOccurrence
		return ret
	}
	return *o.Occurrence
}
...
type NullableMaintenanceOccurrencesIdRespAttrs struct {
	value *MaintenanceOccurrencesIdRespAttrs
	isSet bool
}

func (v NullableMaintenanceOccurrencesIdRespAttrs) Get() *MaintenanceOccurrencesIdRespAttrs {
	return v.value
}

func (v *NullableMaintenanceOccurrencesIdRespAttrs) Set(val *MaintenanceOccurrencesIdRespAttrs) {
	v.value = val
	v.isSet = true
}

func (v NullableMaintenanceOccurrencesIdRespAttrs) IsSet() bool {
	return v.isSet
}

func (v *NullableMaintenanceOccurrencesIdRespAttrs) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMaintenanceOccurrencesIdRespAttrs(val *MaintenanceOccurrencesIdRespAttrs) *NullableMaintenanceOccurrencesIdRespAttrs {
	return &NullableMaintenanceOccurrencesIdRespAttrs{value: val, isSet: true}
}

func (v NullableMaintenanceOccurrencesIdRespAttrs) MarshalJSON() ([]byte, error) {
