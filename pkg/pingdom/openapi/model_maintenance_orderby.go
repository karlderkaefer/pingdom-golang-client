...
func (v *MaintenanceOrderby) UnmarshalJSON(src []byte) error {
	...
	enumTypeValue := MaintenanceOrderby(value)
	for _, existing := range AllowedMaintenanceOrderbyEnumValues {
	...
	return fmt.Errorf("%+v is not a valid MaintenanceOrderby", value)
}

// NewMaintenanceOrderbyFromValue returns a pointer to a valid MaintenanceOrderby
// for the value passed as argument, or an error if the value passed is not allowed by the enum
func NewMaintenanceOrderbyFromValue(v string) (*MaintenanceOrderby, error) {
	ev := MaintenanceOrderby(v)
	if ev.IsValid() {
		return &ev, nil
	} else {
		return nil, fmt.Errorf("invalid value '%v' for MaintenanceOrderby: valid values are %v", v, AllowedMaintenanceOrderbyEnumValues)
	}
}
...
func (v MaintenanceOrderby) Ptr() *MaintenanceOrderby {
	return &v
}

type NullableMaintenanceOrderby struct {
	value *MaintenanceOrderby
	isSet bool
}

func (v NullableMaintenanceOrderby) Get() *MaintenanceOrderby {
	return v.value
}

func (v *NullableMaintenanceOrderby) Set(val *MaintenanceOrderby) {
	v.value = val
	v.isSet = true
}
...
func NewNullableMaintenanceOrderby(val *MaintenanceOrderby) *NullableMaintenanceOrderby {
	return &NullableMaintenanceOrderby{value: val, isSet: true}
}
