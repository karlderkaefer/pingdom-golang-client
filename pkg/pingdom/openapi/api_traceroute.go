...
// Target host.
func (r ApiTracerouteGetRequest) Host(host string) ApiTracerouteGetRequest {
	r.host = &host
	return r
}

// Probe identifier.
func (r ApiTracerouteGetRequest) Probeid(probeid int32) ApiTracerouteGetRequest {
	r.probeid = &probeid
	return r
}

func (r ApiTracerouteGetRequest) Execute() (*Traceroute, *http.Response, error) {
	return r.ApiService.TracerouteGetExecute(r)
}
...
*/
func (a *TracerouteAPIService) TracerouteGet(ctx context.Context) ApiTracerouteGetRequest {
	return ApiTracerouteGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *TracerouteAPIService) TracerouteGetExecute(r ApiTracerouteGetRequest) (*Traceroute, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TracerouteAPIService.TracerouteGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/traceroute"
	...
	if r.probeid != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "probeid", r.probeid, "")
	}
