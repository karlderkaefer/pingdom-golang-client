...
// checks if the ActionsAlertsEntryActions type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ActionsAlertsEntryActions{}
...
func NewActionsAlertsEntryActions() *ActionsAlertsEntryActions {
	this := ActionsAlertsEntryActions{}
	return &this
}
...
func (o *ActionsAlertsEntryActions) GetAlerts() []ActionsAlertsEntryActionsAlertsInner {
	if o == nil || IsNil(o.Alerts) {
		var ret []ActionsAlertsEntryActionsAlertsInner
		return ret
	}
	return o.Alerts
}
...
type NullableActionsAlertsEntryActions struct {
	value *ActionsAlertsEntryActions
	isSet bool
}

func (v NullableActionsAlertsEntryActions) Get() *ActionsAlertsEntryActions {
	return v.value
}

func (v *NullableActionsAlertsEntryActions) Set(val *ActionsAlertsEntryActions) {
	v.value = val
	v.isSet = true
}

func (v NullableActionsAlertsEntryActions) IsSet() bool {
	return v.isSet
}

func (v *NullableActionsAlertsEntryActions) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActionsAlertsEntryActions(val *ActionsAlertsEntryActions) *NullableActionsAlertsEntryActions {
	return &NullableActionsAlertsEntryActions{value: val, isSet: true}
}
