...
// checks if the MaintenanceIdRespAttrsMaintenance type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MaintenanceIdRespAttrsMaintenance{}
...
func NewMaintenanceIdRespAttrsMaintenance() *MaintenanceIdRespAttrsMaintenance {
	this := MaintenanceIdRespAttrsMaintenance{}
	return &this
}
...
func (o *MaintenanceIdRespAttrsMaintenance) GetChecks() MaintenanceIdRespAttrsMaintenanceChecks {
	if o == nil || IsNil(o.Checks) {
		var ret MaintenanceIdRespAttrsMaintenanceChecks
		return ret
	}
	return *o.Checks
}
...
type NullableMaintenanceIdRespAttrsMaintenance struct {
	value *MaintenanceIdRespAttrsMaintenance
	isSet bool
}

func (v NullableMaintenanceIdRespAttrsMaintenance) Get() *MaintenanceIdRespAttrsMaintenance {
	return v.value
}

func (v *NullableMaintenanceIdRespAttrsMaintenance) Set(val *MaintenanceIdRespAttrsMaintenance) {
	v.value = val
	v.isSet = true
}

func (v NullableMaintenanceIdRespAttrsMaintenance) IsSet() bool {
	return v.isSet
}

func (v *NullableMaintenanceIdRespAttrsMaintenance) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMaintenanceIdRespAttrsMaintenance(val *MaintenanceIdRespAttrsMaintenance) *NullableMaintenanceIdRespAttrsMaintenance {
	return &NullableMaintenanceIdRespAttrsMaintenance{value: val, isSet: true}
}

func (v NullableMaintenanceIdRespAttrsMaintenance) MarshalJSON() ([]byte, error) {
