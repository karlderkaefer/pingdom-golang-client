...
// checks if the ContactTargets type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ContactTargets{}
...
func (o *ContactTargets) GetNotificationTargets() ContactTargetsNotificationTargets {
	if o == nil || IsNil(o.NotificationTargets) {
		var ret ContactTargetsNotificationTargets
		return ret
	}
	return *o.NotificationTargets
}

// GetNotificationTargetsOk returns a tuple with the NotificationTargets field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
func (o *ContactTargets) GetTeams() []ContactTargetsTeamsInner {
	if o == nil || IsNil(o.Teams) {
		var ret []ContactTargetsTeamsInner
		return ret
	}
	return o.Teams
}
...
func (o ContactTargets) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.NotificationTargets) {
		toSerialize["notification_targets"] = o.NotificationTargets
	}
	if !IsNil(o.Teams) {
...
func (v NullableContactTargets) Get() *ContactTargets {
	return v.value
}

func (v *NullableContactTargets) Set(val *ContactTargets) {
	v.value = val
	v.isSet = true
}
...
func NewNullableContactTargets(val *ContactTargets) *NullableContactTargets {
	return &NullableContactTargets{value: val, isSet: true}
}
