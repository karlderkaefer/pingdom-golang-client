...
type ApiSingleGetRequest struct {
	...
	queryParameters *SingleGetQueryParametersParameter
}

// Query Parameters to chose
func (r ApiSingleGetRequest) QueryParameters(queryParameters SingleGetQueryParametersParameter) ApiSingleGetRequest {
	r.queryParameters = &queryParameters
	return r
}

func (r ApiSingleGetRequest) Execute() (*SingleResp, *http.Response, error) {
	return r.ApiService.SingleGetExecute(r)
}
...
*/
func (a *SingleAPIService) SingleGet(ctx context.Context) ApiSingleGetRequest {
	return ApiSingleGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *SingleAPIService) SingleGetExecute(r ApiSingleGetRequest) (*SingleResp, *http.Response, error) {
	var (
		...
		formFiles            []formFile
		localVarReturnValue  *SingleResp
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SingleAPIService.SingleGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/single"
	...
	if r.queryParameters != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "Query Parameters", r.queryParameters, "")
	}
