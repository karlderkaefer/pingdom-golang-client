...
// checks if the ActionsAlertsEntry type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ActionsAlertsEntry{}
...
func (o *ActionsAlertsEntry) GetActions() ActionsAlertsEntryActions {
	if o == nil || IsNil(o.Actions) {
		var ret ActionsAlertsEntryActions
		return ret
	}
	return *o.Actions
}
...
type NullableActionsAlertsEntry struct {
	value *ActionsAlertsEntry
	isSet bool
}

func (v NullableActionsAlertsEntry) Get() *ActionsAlertsEntry {
	return v.value
}

func (v *NullableActionsAlertsEntry) Set(val *ActionsAlertsEntry) {
	v.value = val
	v.isSet = true
}
...
func NewNullableActionsAlertsEntry(val *ActionsAlertsEntry) *NullableActionsAlertsEntry {
	return &NullableActionsAlertsEntry{value: val, isSet: true}
}
