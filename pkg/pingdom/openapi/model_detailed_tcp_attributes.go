...
// checks if the DetailedTcpAttributes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DetailedTcpAttributes{}
...
func (o *DetailedTcpAttributes) GetType() DetailedTcpAttributesType {
	if o == nil || IsNil(o.Type) {
		var ret DetailedTcpAttributesType
		return ret
	}
	return *o.Type
}
...
type NullableDetailedTcpAttributes struct {
	value *DetailedTcpAttributes
	isSet bool
}

func (v NullableDetailedTcpAttributes) Get() *DetailedTcpAttributes {
	return v.value
}

func (v *NullableDetailedTcpAttributes) Set(val *DetailedTcpAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullableDetailedTcpAttributes) IsSet() bool {
	return v.isSet
}
...
func NewNullableDetailedTcpAttributes(val *DetailedTcpAttributes) *NullableDetailedTcpAttributes {
	return &NullableDetailedTcpAttributes{value: val, isSet: true}
}
