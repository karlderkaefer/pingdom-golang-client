...
// checks if the DetailedCheckHttpCheck type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DetailedCheckHttpCheck{}
...
func (o *DetailedCheckHttpCheck) GetType() DetailedHttpAttributesType {
	if o == nil || IsNil(o.Type) {
		var ret DetailedHttpAttributesType
		return ret
	}
	return *o.Type
}
...
type NullableDetailedCheckHttpCheck struct {
	value *DetailedCheckHttpCheck
	isSet bool
}

func (v NullableDetailedCheckHttpCheck) Get() *DetailedCheckHttpCheck {
	return v.value
}

func (v *NullableDetailedCheckHttpCheck) Set(val *DetailedCheckHttpCheck) {
	v.value = val
	v.isSet = true
}

func (v NullableDetailedCheckHttpCheck) IsSet() bool {
	return v.isSet
}
...
func NewNullableDetailedCheckHttpCheck(val *DetailedCheckHttpCheck) *NullableDetailedCheckHttpCheck {
	return &NullableDetailedCheckHttpCheck{value: val, isSet: true}
}
