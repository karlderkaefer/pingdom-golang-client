...
// checks if the MaintenanceIdRespAttrsMaintenanceChecks type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MaintenanceIdRespAttrsMaintenanceChecks{}
...
func NewMaintenanceIdRespAttrsMaintenanceChecks() *MaintenanceIdRespAttrsMaintenanceChecks {
	this := MaintenanceIdRespAttrsMaintenanceChecks{}
	return &this
}
...
type NullableMaintenanceIdRespAttrsMaintenanceChecks struct {
	value *MaintenanceIdRespAttrsMaintenanceChecks
	isSet bool
}

func (v NullableMaintenanceIdRespAttrsMaintenanceChecks) Get() *MaintenanceIdRespAttrsMaintenanceChecks {
	return v.value
}

func (v *NullableMaintenanceIdRespAttrsMaintenanceChecks) Set(val *MaintenanceIdRespAttrsMaintenanceChecks) {
	v.value = val
	v.isSet = true
}

func (v NullableMaintenanceIdRespAttrsMaintenanceChecks) IsSet() bool {
	return v.isSet
}

func (v *NullableMaintenanceIdRespAttrsMaintenanceChecks) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMaintenanceIdRespAttrsMaintenanceChecks(val *MaintenanceIdRespAttrsMaintenanceChecks) *NullableMaintenanceIdRespAttrsMaintenanceChecks {
	return &NullableMaintenanceIdRespAttrsMaintenanceChecks{value: val, isSet: true}
}

func (v NullableMaintenanceIdRespAttrsMaintenanceChecks) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMaintenanceIdRespAttrsMaintenanceChecks) UnmarshalJSON(src []byte) error {
	v.isSet = true
