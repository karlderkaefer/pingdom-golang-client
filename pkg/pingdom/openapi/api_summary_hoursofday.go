...
func (r ApiSummaryHoursofdayCheckidGetRequest) From(from int32) ApiSummaryHoursofdayCheckidGetRequest {
	r.from = &from
	return r
}

// End time of period. Format is UNIX timestamp. Default value is current time.
func (r ApiSummaryHoursofdayCheckidGetRequest) To(to int32) ApiSummaryHoursofdayCheckidGetRequest {
	r.to = &to
	return r
}
...
func (r ApiSummaryHoursofdayCheckidGetRequest) Probes(probes string) ApiSummaryHoursofdayCheckidGetRequest {
	r.probes = &probes
	return r
}
...
func (r ApiSummaryHoursofdayCheckidGetRequest) Uselocaltime(uselocaltime bool) ApiSummaryHoursofdayCheckidGetRequest {
	r.uselocaltime = &uselocaltime
	return r
}

func (r ApiSummaryHoursofdayCheckidGetRequest) Execute() (*SummaryHoursofdayRespAttrs, *http.Response, error) {
	return r.ApiService.SummaryHoursofdayCheckidGetExecute(r)
}
...
func (a *SummaryHoursofdayAPIService) SummaryHoursofdayCheckidGetExecute(r ApiSummaryHoursofdayCheckidGetRequest) (*SummaryHoursofdayRespAttrs, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *SummaryHoursofdayRespAttrs
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SummaryHoursofdayAPIService.SummaryHoursofdayCheckidGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/summary.hoursofday/{checkid}"
	...
	if r.uselocaltime != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "uselocaltime", r.uselocaltime, "")
	} else {
		var defaultValue bool = false
		r.uselocaltime = &defaultValue
	}
