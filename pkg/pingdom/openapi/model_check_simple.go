...
// checks if the CheckSimple type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CheckSimple{}
...
func (v NullableCheckSimple) Get() *CheckSimple {
	return v.value
}
...
func NewNullableCheckSimple(val *CheckSimple) *NullableCheckSimple {
	return &NullableCheckSimple{value: val, isSet: true}
}
